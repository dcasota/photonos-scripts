...
| # | Name | Composite | Rationale |
|---|---|---|---|
| 1 | coreutils | 89.7 | Highest integration and ecosystem maturity; de-facto standard |
| 2 | uutils/coreutils | 86.4 | Strong modern security posture and rising popularity |
| 3 | busybox | 75.0 | Compact but higher CVE count and slower release cadence |
...
| # | Name | Composite | Rationale |
|---|---|---|---|
| 1 | wireguard-tools | 91.0 | Highest popularity, strong reputation, excellent documentation and low issue volume. |
| 2 | OpenVPN | 81.1 | Very popular with solid docs but higher CVE count and more ecosystem noise. |
| 3 | strongSwan | 76.6 | Lower popularity but good reputation and manageable issue volume. |

### 7. tzdata — composite_score 90.3
[https://www.iana.org/time-zones](https://www.iana.org/time-zones)  
**Resume:** Official IANA time zone database (Olson) providing global tzdata files for system clocks and applications.

### 8. OpenSSL — composite_score 89.8
...
### 10. activesupport — composite_score 89.5
...
| # | Name | Composite | Rationale |
|---|---|---|---|
| 1 | activesupport | 89.2 | Highest popularity and integration due to Rails ecosystem dominance. |
| 2 | facets | 67.8 | Broad extensions but lower popularity and outdated docs. |
| 3 | powerpack | 61.8 | Lightweight but stale and narrow feature set. |
