...
#
# This script deploys Powershell Core v7.0.0-rc.1 on VMware Photon OS. To start Powershell simply enter "pwsh7.0.0-rc.1".
#
#
# History
# 0.1  17.12.2019   dcasota  Initial release
# 0.2  17.02.2021   dcasota  start command changed to pwsh7.0.0-rc.1
#
# Prerequisites:
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh7.0.0-rc.1.
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v7.0.0-rc.1
# See blog about PowerShell 7.0 https://devblogs.microsoft.com/powershell/announcing-powershell-7-0/.
#
# Powershell is installed in /opt/microsoft/powershell/7.0.0-rc.1/ with a symbolic link "pwsh7.0.0-rc.1" that points to /opt/microsoft/powershell/7.0.0-rc.1/pwsh.
#
#    Especially when running on Photon OS 2.0, two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.0.0-rc.1/profile.ps1.
#       Without those you might run into following issues:
#       find-module VMware.PowerCLI
#       Find-Package: /opt/microsoft/powershell/7.0.0-rc.1/Modules/PowerShellGet/PSModule.psm1
#       Line |
...
#    
#       Each time pwsh7.0.0-rc.1 is started the saved profile with the workarounds is loaded.
...
#  curl -O -J -L https://raw.githubusercontent.com/dcasota/photonos-scripts/master/Pwsh7.0.0-rc.1OnPhotonOS.sh
#  sudo chmod a+x ./Pwsh7.0.0-rc.1OnPhotonOS.sh
#  sudo ./Pwsh7.0.0-rc.1OnPhotonOS.sh
#
