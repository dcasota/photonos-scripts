...
# 
# See release notes https://github.com/PowerShell/PowerShell/releases/tag/v6.2.6
# This script downloads and installs Powershell Core 6.2.6 release, and saves necessary prerequisites in profile
#    /opt/microsoft/powershell/6.2.6/profile.ps1.
#
...
#
#    Two workarounds are necessary to be saved in profile /opt/microsoft/powershell/6.2.6/profile.ps1. Without those you might run into following issues:
