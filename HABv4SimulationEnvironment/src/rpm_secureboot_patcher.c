...
static int generate_linux_mok_spec(rpm_build_config_t *config, rpm_package_info_t *linux_pkg) {
    ...
    fprintf(f,
        ...
        "\n"
        "# Provides same capability as original and obsoletes it\n"
        "# Using versioned Obsoletes ensures MOK package replaces original\n"
        ...
        "Obsoletes:  linux < %%{linux_version}-%%{linux_release}\n"
        "Obsoletes:  linux-esx < %%{linux_version}-%%{linux_release}\n"
        "\n"
        "BuildRequires:  sbsigntools\n"
        "\n"
        "%%description\n"
...
static int generate_shim_mok_spec(rpm_build_config_t *config, 
    ...
    fprintf(f,
        ...
        "Obsoletes:  shim-signed < %%{shim_version}-%%{shim_release}\n"
        "\n"
        "%%description\n"
