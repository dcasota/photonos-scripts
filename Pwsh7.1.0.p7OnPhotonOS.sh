...
#
# This script deploys Powershell v7.1.0-preview.7 on VMware Photon OS. To start Powershell simply enter "pwsh7.1.0.p7".
#
#
# History
...
# Description:
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v7.1.0-preview.7
...
#
# This script downloads and installs Powershell 7.1.0-preview.7 release.
#    Powershell is installed in /opt/microsoft/powershell/7.1.0-preview.7/ with a symbolic link "pwsh7.1.0.p7" that points to /opt/microsoft/powershell/7.1.0-preview.7/pwsh.
#
...
#    
#       Each time pwsh7.1.0.p7 is started the saved profile with the workarounds is loaded.
...
#  sudo chmod a+x ./*.sh
#  sudo ./pwsh7.1.0.p7OnPhotonOS.sh
#
...
export PS_INSTALL_VERSION=7.1.0.p7
