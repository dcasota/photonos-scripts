...
#    Powershell is installed in /opt/microsoft/powershell/7.1.0-preview.1/ with a symbolic link "pwsh7" that points to /opt/microsoft/powershell/7.1.0-preview.1/pwsh.
#
