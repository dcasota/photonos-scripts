...
> Adopted for `sharukhan-cli` on 2026-09-10. The ADR that predated this
> convention (`specs/adr-0001-run-stop-watch.md`) moved to
> `specs/adr/0001-run-stop-watch.md`; the earlier short PRD moved to
> `specs/archive/prd-2026-08-initial.md`.
