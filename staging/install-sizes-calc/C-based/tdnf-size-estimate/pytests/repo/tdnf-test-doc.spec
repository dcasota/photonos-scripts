...
%install
mkdir -p %buildroot/usr/share/doc/tdnf-test-doc
echo "hello" > %buildroot/usr/share/doc/tdnf-test-doc/README
mkdir -p %buildroot/lib/systemd/system/
cat << EOF >> %buildroot/lib/systemd/system/tdnf-test-doc.service
[Unit]
