...
#
# This script deploys Powershell Core v7.0.0-preview.6 on VMware Photon OS. To start Powershell simply enter "pwsh7p6".
#
#
# History
...
# 
# This script downloads and installs Powershell Core 7p6 release, and saves necessary prerequisites in profile
#    /opt/microsoft/powershell/7.0.0-preview.6/profile.ps1.
#
#    Powershell is installed in /opt/microsoft/powershell/7.0.0-preview.6/ with a symbolic link "pwsh7p6" that points to /opt/microsoft/powershell/7.0.0-preview.6/pwsh.
#
#    Two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.0.0-preview.6/profile.ps1.
#       Each time pwsh7p6 is started the saved profile with the workarounds is loaded.
