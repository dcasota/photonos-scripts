...
#
# This script deploys Powershell v7.1.0-preview.6 on VMware Photon OS. To start Powershell simply enter "pwsh7.1.0.p6".
#
#
# History
...
#
# This script downloads and installs Powershell 7.1.0-preview.6 release.
#    Powershell is installed in /opt/microsoft/powershell/7.1.0-preview.6/ with a symbolic link "pwsh7.1.0.p6" that points to /opt/microsoft/powershell/7.1.0-preview.6/pwsh.
#
...
#    
#       Each time pwsh7.1.0.p6 is started the saved profile with the workarounds is loaded.
...
#  sudo chmod a+x ./*.sh
#  sudo ./pwsh7.1.0.p6OnPhotonOS.sh
#
...
export PS_INSTALL_VERSION=7.1.0.p6
