# Snyk Issues Report (6.0)

Generated: 06/02/2026 01:20:15
Total source packages processed: 700
Tool used: SnykCLI
...
## Processing status (branch 6.0)

| Step | Detail |
|---|---|
| SAST scan | ok (698 subdirs) |
| Agent-scan coverage | configs found=17, scans run=0, failed=0 |
