...
| Metric | Count |
|---|---|
| Total issues overall | 1163 |
| High with crypto | 4 |
| High without crypto | 8 |
| Medium | 234 |
| Low | 917 |
...
| Potential Negative Number Used as Index | 1 |
| Path Traversal | 1 |
| DOM-based Cross-site Scripting (XSS) | 1 |
| Command Injection | 1 |
