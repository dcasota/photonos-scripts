...
Generated: 06/02/2026 01:20:09
Total source packages processed: 673
Tool used: SnykCLI
...
## Processing status (branch 4.0)

| Step | Detail |
|---|---|
| SAST scan | ok (671 subdirs) |
| Agent-scan coverage | configs found=16, scans run=0, failed=0 |
