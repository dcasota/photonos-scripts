...
#
# This script installs built-in Powershell Core 6.1.0 on VMware Photon OS and adds modules PackageManagement and PowerShellGet . To start Powershell simply enter "pwsh".
#
#
# History
