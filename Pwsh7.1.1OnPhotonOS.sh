...
#
# This script downloads and installs Powershell 7.1.1 release.
...
#
#    Especially when running on Photon OS 2.0, some workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.1.1/profile.ps1.
