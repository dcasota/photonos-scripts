...
#
# This script deploys Powershell Core v7.0.0-rc.3 on VMware Photon OS. To start Powershell simply enter "pwsh7rc3".
#
#
# History
...
# 
# This script downloads and installs Powershell Core 7rc3 release, and saves necessary prerequisites in profile
#    /opt/microsoft/powershell/7.0.0-rc.3/profile.ps1.
#
#    Powershell is installed in /opt/microsoft/powershell/7.0.0-rc.3/ with a symbolic link "pwsh7rc3" that points to /opt/microsoft/powershell/7.0.0-rc.3/pwsh.
#
#    Two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.0.0-rc.3/profile.ps1. With those your might run into following issues:
...
#    
#       Each time pwsh7rc3 is started the saved profile with the workarounds is loaded.
