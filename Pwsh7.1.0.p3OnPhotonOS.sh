...
#
# This script deploys Powershell v7.1.0-preview.3 on VMware Photon OS. To start Powershell simply enter "pwsh7.1.0.p3".
#
#
# History
...
#
# This script downloads and installs Powershell 7.1.0-preview.3 release.
#    Powershell is installed in /opt/microsoft/powershell/7.1.0-preview.3/ with a symbolic link "pwsh7.1.0.p3" that points to /opt/microsoft/powershell/7.1.0-preview.3/pwsh.
#
...
#    
#       Each time pwsh7.1.0.p3 is started the saved profile with the workarounds is loaded.
...
#  sudo chmod a+x ./*.sh
#  sudo ./pwsh7.1.0.p3OnPhotonOS.sh
#
...
export PS_INSTALL_VERSION=7.1.0.p3
