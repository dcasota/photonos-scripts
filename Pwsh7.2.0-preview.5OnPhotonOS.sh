#!/bin/sh
# Deploy Powershell v7.2.0-preview.5 on VMware Photon OS
#
# This script deploys Powershell v7.2.0-preview.5 on VMware Photon OS. To start Powershell simply enter "pwsh7.2.0-preview.5".
#
#
# History
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh7.2.0-preview.5.
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v7.2.0-preview.5
# See blog about PowerShell 7.0 https://devblogs.microsoft.com/powershell/announcing-powershell-7-0/.
#
# Powershell is installed in /opt/microsoft/powershell/7.2.0-preview.5/ with a symbolic link "pwsh7.2.0-preview.5" that points to /opt/microsoft/powershell/7.2.0-preview.5/pwsh.
#
#    Especially when running on Photon OS 2.0, two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.2.0-preview.5/profile.ps1.
#       Without those you might run into following issues:
#       find-module VMware.PowerCLI
#       Find-Package: /opt/microsoft/powershell/7.2.0-preview.5/Modules/PowerShellGet/PSModule.psm1
#       Line |
...
#    
#       Each time pwsh7.2.0-preview.5 is started the saved profile with the workarounds is loaded.
...
#  curl -O -J -L https://raw.githubusercontent.com/dcasota/photonos-scripts/master/Pwsh7.2.0-preview.5OnPhotonOS.sh
#  sudo chmod a+x ./Pwsh7.2.0-preview.5OnPhotonOS.sh
#  sudo ./Pwsh7.2.0-preview.5OnPhotonOS.sh
#
...
export PS_VERSION=7.2.0-preview.5
export PACKAGE_VERSION=7.2.0-preview.5
...
export PS_INSTALL_VERSION=7.2.0-preview.5
