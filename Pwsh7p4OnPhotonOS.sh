...
#
# This script deploys Powershell Core v7.0.0-preview.4 on VMware Photon OS. To start Powershell simply enter "pwsh7p4".
#
#
# History
...
# Description:
# 
# This script downloads and installs Powershell Core 7p4 release, and provides side-by-side installation functionality.
#
#    Powershell is installed in /opt/microsoft/powershell/7.0.0-preview.4/ with a symbolic link "pwsh7p4" that points to /opt/microsoft/powershell/7.0.0-preview.4/pwsh.
#
#    Two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.0.0-preview.4/profile.ps1.
#       Each time pwsh7p4 is started the saved profile with the workarounds is loaded.
