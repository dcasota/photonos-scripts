...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 38 | PyPAM.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, fcgi.spec, filesystem.spec, finger.spec, hyper-v.spec, iptraf.spec, libassuan.spec, libgsystem.spec, libsepol.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, procps-ng.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, wal2json18.spec, wireguard-tools.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 32 | PyYAML.spec, apparmor.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, perl-Net-SSLeay.spec, proto.spec, re2.spec, ruby.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 43 | apache-maven.spec, ca-certificates-nxtgn-openssl.spec, cassandra.spec, eventlog.spec, fakeroot.spec, fatrace.spec, filesystem.spec, fmt.spec, fuse3.spec, iotop.spec, json_spirit.spec, lasso.spec, libX11.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libevent.spec, libical.spec, libnetconf2.spec, libtraceevent.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, openresty.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-JSON.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, runc.spec, termshark.spec, tiptop.spec, wireguard-tools.spec, xorg-applications.spec |
