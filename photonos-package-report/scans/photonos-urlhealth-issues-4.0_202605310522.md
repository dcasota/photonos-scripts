...
**Source file:** photonos-urlhealth-4.0_202605310522.prn
...
|---|---|---|---|---|
| 1 | chkconfig.spec | chkconfig | `https://github.com/fedora-sysv/chkconfig/archive/refs/tags/1.9.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | fping.spec | fping | `https://github.com/schweikert/fping/archive/refs/tags/v5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | haveged.spec | haveged | `https://github.com/jirka-h/haveged/archive/refs/tags/v1.9.18.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | repmgr15.spec | repmgr | `https://github.com/EnterpriseDB/repmgr/archive/refs/tags/v5.3.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
