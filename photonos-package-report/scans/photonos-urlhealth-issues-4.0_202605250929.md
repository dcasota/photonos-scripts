...
**Source file:** photonos-urlhealth-4.0_202605250929.prn
...
|---|---|---|---|---|
| 1 | chrony.spec | chrony | Warning: chrony.spec Source0 version 4.0 is higher than detected latest version 3.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | linux.spec | linux | Warning: linux.spec Source0 version 5.10.255-acvp} is higher than detected latest version 5.10.257 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 15 | rsyslog.spec | rsyslog | Warning: rsyslog.spec Source0 version 8.2306.0 is higher than detected latest version 4.5.8 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | gtest.spec | gtest | `https://github.com/google/googletest/archive/refs/tags/release-1.10.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
