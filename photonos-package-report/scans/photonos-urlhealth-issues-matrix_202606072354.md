...
**226** packages with at least one issue across 8 branches.
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 42 | PyYAML.spec, apparmor.spec, btrfs-progs.spec, c-ares.spec, containers-common.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, fio.spec, fuse-overlayfs-snapshotter.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, iptables.spec, libmspack.spec, libnss-ato.spec, libteam.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, nss-pam-ldapd.spec, ntp.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, perl-Try-Tiny.spec, polkit.spec, proto.spec, re2.spec, socat.spec, strongswan.spec, syslinux.spec, systemd.spec, tdnf.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 73 | abseil-cpp.spec, ca-certificates-nxtgn-openssl.spec, check.spec, cloud-utils.spec, commons-daemon.spec, cppcheck.spec, dotnet-runtime.spec, dovecot-pigeonhole.spec, dovecot.spec, doxygen.spec, efibootmgr.spec, erlang-sd_notify.spec, eventlog.spec, expat.spec, fail2ban.spec, filesystem.spec, fuse3.spec, google-compute-engine.spec, gtest.spec, harfbuzz.spec, hyperscan.spec, iana-etc.spec, iotop.spec, ipxe.spec, isa-l.spec, json_spirit.spec, kubernetes-dns.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libical.spec, libmspack.spec, libnss-ato.spec, libuv.spec, lighttpd.spec, linux-api-headers.spec, linux-esx.spec, lldpad.spec, log4cpp.spec, lzo.spec, netkit-telnet.spec, nghttp2.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk17.spec, openjdk25.spec, openssh.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-Exporter-Tiny.spec, perl-IPC-Run.spec, python-antlrpythonruntime.spec, python-linux-procfs.spec, python3-hatchling.spec, s3fs-fuse.spec, salt3.spec, shadow.spec, snoopy.spec, telegraf.spec, termshark.spec, tiptop.spec, tzdata.spec, whois.spec, xinetd.spec, xorg-applications.spec, zchunk.spec, zip.spec, zsh.spec, zstd.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 52 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, cronie.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, iputils.spec, kbd.spec, leveldb.spec, libclc.spec, libfastjson.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mozjs.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-filelock.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, vulkan-tools.spec, wayland-protocols.spec |
| 8 | Other warnings (VMware internal URL, unmaintained repo, etc.) | 🟡 Low-Medium | 57 | alternatives.spec, autoconf213.spec, bluez-tools.spec, c-rest-engine.spec, cloud-network-setup.spec, copenapi.spec, crash.spec, cve-check-tool.spec, dbus-python.spec, dcerpc.spec, dhcp.spec, etcd-3.3.27.spec, findutils.spec, font-util.spec, heapster.spec, http-parser.spec, icu.spec, kubernetes-dashboard.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libdrm.spec, libfontenc.spec, libgsystem.spec, libpciaccess.spec, libsepol.spec, libslirp.spec, libtar.spec, lightstep-tracer-cpp.spec, likewise-open.spec, motd.spec, pcre.spec, python-argparse.spec, python-atomicwrites.spec, python-ipaddr.spec, python-lockfile.spec, python-pycodestyle.spec, python-subprocess32.spec, python-terminaltables.spec, python3-Pygments.spec, python3-trove-classifiers.spec, python3-wheel.spec, scons.spec, sqlite2.spec, util-macros.spec, xtrans.spec |
