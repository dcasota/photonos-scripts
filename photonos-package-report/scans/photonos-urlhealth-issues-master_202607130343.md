...
**Source file:** photonos-urlhealth-master_202607130343.prn
...
|---|---|---|---|---|
| 1 | apr-util.spec | apr-util | Warning: apr-util.spec Source0 version 1.6.3 is higher than detected latest version 0.9.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | fakeroot.spec | fakeroot | Warning: fakeroot.spec Source0 version 1.37.1.1 is higher than detected latest version 1.31 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | mysql.spec | mysql | Warning: mysql.spec Source0 version 8.4.2 is higher than detected latest version 5.1.15 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | pgaudit13.spec | pgaudit | Warning: pgaudit13.spec Source0 version 1.5.2 is higher than detected latest version 1.0.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 11 | stunnel.spec | stunnel | Warning: stunnel.spec Source0 version 5.72 is higher than detected latest version 3.21 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 12 | syslinux.spec | syslinux | Warning: syslinux.spec Source0 version 6.04 is higher than detected latest version 3.74 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 13 | wireshark.spec | wireshark | Warning: wireshark.spec Source0 version 4.2.7 is higher than detected latest version 4.1.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | ddclient.spec | ddclient | `https://github.com/ddclient/ddclient/releases/download/v3.9.1/ddclient-3.9.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 3 | docker.spec | docker | `https://github.com/moby/moby/archive/refs/tags/docker-v24.0.9.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | dtc.spec | dtc | `https://www.kernel.org/pub/software/utils/dtc/dtc-1.6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 5 | elixir.spec | elixir | `https://github.com/elixir-lang/elixir/archive/v1.16.3/elixir-1.16.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | expat.spec | expat | `https://github.com/libexpat/libexpat/releases/download/R_2.6.0/expat-2.6.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | hunspell.spec | hunspell | `https://github.com/hunspell/hunspell/releases/download/v1.7.2/hunspell-1.7.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 12 | iana-etc.spec | iana-etc | `https://github.com/Mic92/iana-etc/releases/download/2.30/iana-etc-2.30.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | iperf.spec | iperf | `https://github.com/esnet/iperf/archive/refs/tags/3.17.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 15 | jansson.spec | jansson | `https://github.com/akheron/jansson/archive/refs/tags/v2.13.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | kubernetes-dns.spec | kubernetes-dns | `https://github.com/kubernetes/dns/archive/refs/tags/1.22.20.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 17 | less.spec | less | `https://github.com/gwsw/less/archive/refs/tags/v608.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 21 | libnss-ato.spec | libnss-ato | `https://github.com/donapieppo/libnss-ato/archive/refs/tags/v20240514.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 22 | libsemanage.spec | libsemanage | `https://github.com/SELinuxProject/selinux/releases/download/3.5/libsemanage-3.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 23 | libuv.spec | libuv | `https://github.com/libuv/libuv/archive/refs/tags/v1.44.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 24 | linux.spec | linux | `http://www.kernel.org/pub/linux/kernel/v6.x/linux-6.1.83-acvp}.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | mokutil.spec | mokutil | `https://github.com/lcp/mokutil/archive/refs/tags/0.7.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 33 | perl-Try-Tiny.spec | perl-Try-Tiny | `https://github.com/p5sagit/Try-Tiny/archive/refs/tags/v0.31.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 34 | pgaudit14.spec | pgaudit | `https://github.com/pgaudit/pgaudit/archive/refs/tags/1.6.1.6.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 35 | rt-tests.spec | rt-tests | `https://git.kernel.org/pub/scm/utils/rt-tests/rt-tests.git/snapshot/rt-tests-2.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 36 | runc.spec | runc | `https://github.com/opencontainers/runc/archive/refs/tags/v1.1.14.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 37 | s3fs-fuse.spec | s3fs-fuse | `https://github.com/s3fs-fuse/s3fs-fuse/archive/refs/tags/v1.91.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 38 | shadow.spec | shadow | `https://github.com/shadow-maint/shadow/archive/refs/tags/4.13.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 39 | tpm2-tss.spec | tpm2-tss | `https://github.com/tpm2-software/tpm2-tss/archive/refs/tags/3.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 40 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2022g.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 41 | u-boot.spec | u-boot | `https://github.com/u-boot/u-boot/archive/refs/tags/v2023.01.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 42 | unbound.spec | unbound | `https://github.com/NLnetLabs/unbound/archive/refs/tags/release-1.21.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 43 | xinetd.spec | xinetd | `https://github.com/xinetd-org/xinetd/archive/refs/tags/xinetd-2.3.15.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
