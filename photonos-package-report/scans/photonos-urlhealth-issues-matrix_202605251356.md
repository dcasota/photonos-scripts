...
**118** packages with at least one issue across 1 branches.
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 17 | cdrkit.spec, filesystem.spec, hyper-v.spec, procps-ng.spec, python-daemon.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, wal2json18.spec |
