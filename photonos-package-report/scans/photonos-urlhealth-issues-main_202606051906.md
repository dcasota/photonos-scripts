...
**Source file:** photonos-urlhealth-main_202606051906.prn
...
| 15 | whois.spec | whois | Warning: whois.spec Source0 version 5.5.15 is higher than detected latest version 5.5.12 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 23 | openssh.spec | openssh | .10.3.P1 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
