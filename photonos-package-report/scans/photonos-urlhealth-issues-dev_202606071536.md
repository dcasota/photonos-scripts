...
**Source file:** photonos-urlhealth-dev_202606071536.prn
...
|---|---|---|---|---|
| 1 | calico-bird.spec | calico-bird | `https://github.com/projectcalico/bird/archive/refs/tags/v0.3.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 2 | dracut.spec | dracut | `https://github.com/dracutdevs/dracut/archive/refs/tags/059.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | lm-sensors.spec | lm-sensors | `https://github.com/lm-sensors/lm-sensors/archive/refs/tags/V3.6.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 16 | krb5.spec | krb5 | 1.22.2 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 63 | wayland-protocols.spec | wayland-protocols | 1.49 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
