...
**Source file:** photonos-urlhealth-4.0_202606051548.prn

**Total packages analyzed:** 1032

**Total packages with issues:** 135
...
| 15 | tmux.spec | tmux | Warning: tmux.spec Source0 version 3.1b is higher than detected latest version 3.6 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | govmomi.spec | govmomi | `https://github.com/vmware/govmomi/archive/refs/tags/v0.28.0.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | mercurial.spec | mercurial | `https://www.mercurial-scm.org/release/mercurial-5.5.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
