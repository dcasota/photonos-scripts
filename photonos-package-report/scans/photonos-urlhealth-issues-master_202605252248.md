...
**Source file:** photonos-urlhealth-master_202605252248.prn
...
| 7 | nerdctl.spec | nerdctl | Warning: nerdctl.spec Source0 version 1.4.0 is higher than detected latest version 0.16.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | gnuplot.spec | gnuplot | `https://github.com/gnuplot/gnuplot/archive/refs/tags/5.4.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 4 | lapack.spec | lapack | `https://github.com/Reference-LAPACK/lapack/archive/refs/tags/v3.11.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | oniguruma.spec | oniguruma | `https://github.com/kkos/oniguruma/releases/download/v6.9.8/onig-6.9.8.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
