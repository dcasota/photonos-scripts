...
**Source file:** photonos-urlhealth-dev_202607120943.prn
...
| 10 | ruby.spec | ruby | Warning: ruby.spec Source0 version 3.3.0 is higher than detected latest version 1.8.7.374 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | apache-maven.spec | apache-maven | `https://github.com/apache/maven/archive/refs/tags/maven-3.9.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | drpm.spec | drpm | `https://github.com/rpm-software-management/drpm/archive/refs/tags/0.5.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | haproxy-dataplaneapi.spec | haproxy-dataplaneapi | `https://github.com/haproxytech/dataplaneapi/archive/refs/tags/v2.7.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | libnetfilter_conntrack.spec | libnetfilter_conntrack | `https://www.netfilter.org/projects/libnetfilter_conntrack/files/libnetfilter_conntrack-1.0.9.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 22 | protobuf-c.spec | protobuf-c | `https://github.com/protobuf-c/protobuf-c/archive/refs/tags/v1.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
