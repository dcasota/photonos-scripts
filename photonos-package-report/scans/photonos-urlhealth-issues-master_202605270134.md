...
**Source file:** photonos-urlhealth-master_202605270134.prn
...
|---|---|---|---|---|
| 1 | cython3.spec | cython3 | `https://github.com/cython/cython/archive/refs/tags/0.29.32.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | mm-common.spec | mm-common | `https://gitlab.gnome.org/GNOME/mm-common/-/archive/1.0.5/mm-common-1.0.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | sbsigntools.spec | sbsigntools | `https://git.kernel.org/pub/scm/linux/kernel/git/jejb/sbsigntools.git/snapshot/sbsigntools-0.9.5.tar.` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
