...
**Source file:** photonos-urlhealth-5.0_202606031711.prn
...
| 5 | jq.spec | jq | Warning: jq.spec Source0 version 1.8.1 is higher than detected latest version 1.7.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | linux-esx.spec | linux | Warning: linux-esx.spec Source0 version 6.12.87 is higher than detected latest version 6.1.175 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 9 | linux.spec | linux | Warning: linux.spec Source0 version 6.12.87-acvp} is higher than detected latest version 6.1.175 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | mysql.spec | mysql | Warning: mysql.spec Source0 version 8.4.9 is higher than detected latest version 5.1.24 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 13 | nginx.spec | nginx | Warning: nginx.spec Source0 version 1.30.2 is higher than detected latest version 0.8.21 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 15 | perl-Module-ScanDeps.spec | perl-Module-ScanDeps | Warning: perl-Module-ScanDeps.spec Source0 version 1.37 is higher than detected latest version 1.18 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | harfbuzz.spec | harfbuzz | `https://github.com/harfbuzz/harfbuzz/releases/download/7.0.1/harfbuzz-7.0.1.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | ninja-build.spec | ninja-build | `https://github.com/ninja-build/ninja/archive/refs/tags/v1.12.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | pmd-ng.spec | pmd-ng | `https://github.com/vmware/pmd-next-gen/archive/refs/tags/v0.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 16 | virt-what.spec | virt-what | `https://people.redhat.com/~rjones/virt-what/files/virt-what-1.25.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
