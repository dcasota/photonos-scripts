...
**Source file:** photonos-urlhealth-5.0_202605221215.prn
...
| 27 | rubygem-retriable.spec | rubygem-retriable | `https://rubygems.org/downloads/retriable-3.1.2.gem` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
