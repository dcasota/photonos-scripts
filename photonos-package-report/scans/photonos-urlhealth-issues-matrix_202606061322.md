...
|---|---|---|---|---|
| 1 | Source URL blank / macro unresolved (UrlHealth=blank) | 🔴 High | 3 | chromium.spec, python-pexpect.spec, raspberrypi-firmware.spec |
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 67 | PyPAM.spec, alternatives.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, dhcp.spec, fcgi.spec, filesystem.spec, finger.spec, font-util.spec, hyper-v.spec, iptraf.spec, libICE.spec, libSM.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXcursor.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libassuan.spec, libfontenc.spec, libgsystem.spec, libpciaccess.spec, libsepol.spec, libxshmfence.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, nss.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, openjdk8_aarch64.spec, procps-ng.spec, proto.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-passlib.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, util-macros.spec, wal2json18.spec, xorg-fonts.spec, xtrans.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 34 | PyYAML.spec, apparmor.spec, capstone.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, elixir.spec, glibmm.spec, gst-plugins-bad.spec, hawkey.spec, iana-etc.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, podman.spec, python3-pip.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 33 | ca-certificates-nxtgn-openssl.spec, dovecot-pigeonhole.spec, dovecot.spec, eventlog.spec, filesystem.spec, fuse3.spec, gcovr.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, msr-tools.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, tiptop.spec, tzdata.spec, xorg-applications.spec |
