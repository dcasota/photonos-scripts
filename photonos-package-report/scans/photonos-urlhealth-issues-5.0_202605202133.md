...
**Source file:** photonos-urlhealth-5.0_202605202133.prn
...
| 12 | python-pexpect.spec | python-pexpect | Warning: python-pexpect.spec Source0 version 4.8.0 is higher than detected latest version 3.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
