...
**Source file:** photonos-urlhealth-main_202605251151.prn
...
| 6 | libnftnl.spec | libnftnl | `https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.3.1.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | perl-IO-Socket-SSL.spec | perl-IO-Socket-SSL | `https://github.com/noxxi/p5-io-socket-ssl/archive/refs/tags/2.090.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 33 | mozjs.spec | mozjs | 151.0.1 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
