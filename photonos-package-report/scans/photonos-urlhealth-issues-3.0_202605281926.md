...
**Source file:** photonos-urlhealth-3.0_202605281926.prn
...
| 2 | compat-gdbm.spec | compat-gdbm | `https://ftp.funet.fi/pub/gnu/ftp.gnu.org/gnu/gdbm/gdbm-1.8.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 4 | gmp.spec | gmp | `http://ftp.funet.fi/pub/gnu/ftp.gnu.org/gnu/gmp/gmp-6.1.2.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
