...
**Source file:** photonos-urlhealth-dev_202605310547.prn
...
|---|---|---|---|---|
| 1 | bash-completion.spec | bash-completion | Warning: bash-completion.spec Source0 version 2.15.0 is higher than detected latest version 1.99 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | git.spec | git | Warning: git.spec Source0 version 2.45.1 is higher than detected latest version 2.38.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | keyutils.spec | keyutils | `https://git.kernel.org/pub/scm/linux/kernel/git/dhowells/keyutils.git/snapshot/keyutils-1.6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | nghttp2.spec | nghttp2 | `https://github.com/nghttp2/nghttp2/releases/download/v1.48.0/nghttp2-1.48.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | subversion.spec | subversion | `https://github.com/apache/subversion/archive/refs/tags/1.14.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2022g.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
