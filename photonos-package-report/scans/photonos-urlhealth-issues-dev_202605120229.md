...
**Source file:** photonos-urlhealth-dev_202605120229.prn
...
| 14 | tcpdump.spec | tcpdump | `http://www.tcpdump.org/release/%{name}-%{version}.tar.gz` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
| 2 | docker-py.spec | docker-py | Warning: docker-py.spec Source0 version 6.0.0 is higher than detected latest version 0.5.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | nvme-cli.spec | nvme-cli | Warning: nvme-cli.spec Source0 version 2.3 is higher than detected latest version 2.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 15 | python-tornado.spec | python-tornado | Warning: python-tornado.spec Source0 version 6.2 is higher than detected latest version 4.3.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 18 | u-boot.spec | u-boot | Warning: u-boot.spec Source0 version 2023.01 is higher than detected latest version 2015.10 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 16 | libnetfilter_conntrack.spec | libnetfilter_conntrack | `https://www.netfilter.org/projects/libnetfilter_conntrack/files/libnetfilter_conntrack-1.0.9.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
