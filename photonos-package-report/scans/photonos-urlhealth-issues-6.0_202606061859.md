...
**Source file:** photonos-urlhealth-6.0_202606061859.prn
...
| 29 | libclc.spec | libclc | 22.1.7 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
