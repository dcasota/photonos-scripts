...
**Source file:** photonos-urlhealth-5.0_202605221501.prn
...
| 28 | xmlstarlet.spec | xmlstarlet | `http://downloads.sourceforge.net/xmlstar/xmlstarlet-1.6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
