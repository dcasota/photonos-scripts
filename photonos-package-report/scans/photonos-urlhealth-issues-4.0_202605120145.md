...
**Source file:** photonos-urlhealth-4.0_202605120145.prn
...
| 19 | tcpdump.spec | tcpdump | `http://www.tcpdump.org/release/%{name}-%{version}.tar.gz` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
| 11 | perl-Config-IniFiles.spec | perl-Config-IniFiles | Warning: perl-Config-IniFiles.spec Source0 version 3.000003 is higher than detected latest version 2.75 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 21 | vim.spec | vim | Warning: vim.spec Source0 version 9.1.1898 is higher than detected latest version 9.1.0484 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | gettext.spec | gettext | `http://ftp.funet.fi/pub/gnu/ftp.gnu.org/gnu/gettext/gettext-0.21.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 18 | libtool.spec | libtool | `http://ftp.funet.fi/pub/gnu/ftp.gnu.org/gnu/libtool/libtool-2.4.6.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | python-numpy.spec | python-numpy | `https://github.com/numpy/numpy/archive/refs/tags/v1.23.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
