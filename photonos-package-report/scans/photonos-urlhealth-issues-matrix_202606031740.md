...
**237** packages with at least one issue across 8 branches.
...
| open-vm-tools.spec | 🟠7 | 🟠7 | 🟠7 | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠6 | 🟠7 | ⚪ | ⚪ |
| openjdk10.spec | 🟠7 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
...
| openresty.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| openssh.spec | 🟠7 | 🟠6 | 🟠7 | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | 📌 |
| openssl.spec | 🟠5 | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | 📌 |
| pcre.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | 🟡8 | ⚪ | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ |
| pcstat.spec | 🟠5 | 🟠5 | 🟠5 | ⚪ | ⚪ | 🟠5 | ⚪ | 🟠5 | 🟠5 | 🟠5 | ⚪ | ⚪ |
| perl-CGI.spec | 🟠6 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| perl-Clone.spec | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ |
| perl-DBD-SQLite.spec | 🟢 | 🟠5 | 🟢 | ⚪ | ⚪ | 🟠6 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 37 | PyPAM.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, fcgi.spec, filesystem.spec, finger.spec, hyper-v.spec, iptraf.spec, libassuan.spec, libgsystem.spec, libsepol.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, procps-ng.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, wal2json18.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 41 | PyYAML.spec, apparmor.spec, automake.spec, bazel.spec, containers-common.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, jq.spec, libmspack.spec, libnss-ato.spec, libxslt.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, lvm2.spec, mdadm.spec, mesa.spec, motd.spec, mysql.spec, netmgmt.spec, nginx.spec, openssl.spec, pcstat.spec, perl-DBD-SQLite.spec, perl-Module-ScanDeps.spec, proto.spec, python3-setuptools.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 61 | ca-certificates-nxtgn-openssl.spec, conntrack-tools.spec, cryptsetup.spec, cython3.spec, docker-pycreds.spec, dovecot-pigeonhole.spec, dovecot.spec, duktape.spec, eventlog.spec, filesystem.spec, fuse3.spec, gstreamer.spec, harfbuzz.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libcgroup.spec, libdaemon.spec, libdisplay-info.spec, librdkafka.spec, libsoup.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lvm2.spec, lzo.spec, msr-tools.spec, net-snmp.spec, net-tools.spec, netkit-telnet.spec, ninja-build.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, open-vm-tools.spec, openjdk25.spec, openresty.spec, openssh.spec, perl-CGI.spec, perl-Clone.spec, perl-DBD-SQLite.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-JSON.spec, perl-Object-Accessor.spec, pmd-ng.spec, policycoreutils.spec, psmisc.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, runc.spec, tdnf.spec, tiptop.spec, tpm2-tss.spec, tzdata.spec, util-linux.spec, virt-what.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 85 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bazel.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cronie.spec, dbus-python.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, font-util.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libcap.spec, libclc.spec, libdrm.spec, libfastjson.spec, libfontenc.spec, libpciaccess.spec, libslirp.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mozjs.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, rng-tools.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, util-macros.spec, vulkan-tools.spec, wayland-protocols.spec, wireshark.spec, xtrans.spec |
