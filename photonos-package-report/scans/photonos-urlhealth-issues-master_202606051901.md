...
**Source file:** photonos-urlhealth-master_202606051901.prn
...
| 3 | iptraf-ng.spec | iptraf-ng | `https://github.com/iptraf-ng/iptraf-ng/archive/refs/tags/v1.2.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | kubernetes-metrics-server.spec | kubernetes-metrics-server | `https://github.com/kubernetes-sigs/metrics-server/archive/refs/tags/v0.3.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
