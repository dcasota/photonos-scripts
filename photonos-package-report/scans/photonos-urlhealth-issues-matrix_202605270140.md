...
**219** packages with at least one issue across 8 branches.
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 42 | PyPAM.spec, acl.spec, attr.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, dmidecode.spec, fcgi.spec, filesystem.spec, finger.spec, freetype2.spec, hyper-v.spec, iptraf.spec, libassuan.spec, libgsystem.spec, libpipeline.spec, libsepol.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, procps-ng.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, wal2json18.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 34 | PyYAML.spec, apparmor.spec, boost.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gobgp.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pam_tacplus.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vim.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 41 | abseil-cpp.spec, apache-maven.spec, ca-certificates-nxtgn-openssl.spec, cython3.spec, eventlog.spec, filesystem.spec, font-util.spec, iotop.spec, json_spirit.spec, lasso.spec, libXext.spec, libaio.spec, libbpf.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libnetfilter_conntrack.spec, libpciaccess.spec, librsync.spec, libtracefs.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, mm-common.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, pycurl.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, sbsigntools.spec, tiptop.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 86 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, chrpath.spec, clang.spec, cronie.spec, dbus-python.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, font-util.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libcap.spec, libclc.spec, libdrm.spec, libfastjson.spec, libfontenc.spec, libpciaccess.spec, libslirp.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mm-common.spec, mozjs.spec, nano.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perftest.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu-img.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, util-macros.spec, vulkan-tools.spec, wayland-protocols.spec, wireshark.spec, xtrans.spec |
