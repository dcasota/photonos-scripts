...
**Source file:** photonos-urlhealth-3.0_202605250917.prn
...
| 9 | meson.spec | meson | `https://github.com/mesonbuild/meson/releases/download/0.56.2/meson-0.56.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | nss-pam-ldapd.spec | nss-pam-ldapd | `https://github.com/arthurdejong/nss-pam-ldapd/archive/refs/tags/0.9.11.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 17 | telegraf.spec | telegraf | `https://github.com/influxdata/telegraf/archive/refs/tags/v1.28.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 18 | tiptop.spec | tiptop | `https://files.inria.fr/pacap/tiptop/tiptop-2.3.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | http-parser.spec | http-parser | 200 |  | Warning: repo isn't maintained anymore. | Upstream repo is no longer maintained. Consider finding a fork, alternative, or mark package as archived. |
