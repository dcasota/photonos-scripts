...
**243** packages with at least one issue across 8 branches.
...
| cryptsetup.spec | 🟢 | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟠5 | 🟢 | ⚪ | ⚪ |
| cups.spec | ⚪ | 🟠6 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| cve-check-tool.spec | 🟠5 | 🟡8 | ⚪ | 📌 | ⚪ | 🟡8 | ⚪ | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ |
...
| perl-List-MoreUtils.spec | 🟠7 | 🟠5 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
...
| pth.spec | 🟠7 | 🟠7 | ⚪ | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | ⚪ | 📌 | ⚪ |
| python-ConcurrentLogHandler.spec | 🟢 | 🟠5 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | 📌 |
...
| vulkan-loader.spec | ⚪ | 🟢 | 🟠5 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | 📌 |
| vulkan-tools.spec | ⚪ | 🟠6 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
| wal2json18.spec | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ |
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 42 | PyPAM.spec, alternatives.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, dhcp.spec, fcgi.spec, filesystem.spec, finger.spec, hyper-v.spec, iptraf.spec, libassuan.spec, libgsystem.spec, libsepol.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, nss.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, openjdk8_aarch64.spec, procps-ng.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-passlib.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, wal2json18.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 43 | PyYAML.spec, apparmor.spec, bazel.spec, btrfs-progs.spec, calico.spec, containers-common.spec, cryptsetup.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, erlang.spec, etcd.spec, glib-networking.spec, google-compute-engine.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, librdkafka.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-List-MoreUtils.spec, perl-Module-ScanDeps.spec, proto.spec, python-ConcurrentLogHandler.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vulkan-loader.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 66 | ansible.spec, automake.spec, ca-certificates-nxtgn-openssl.spec, chrony.spec, cri-tools.spec, crun.spec, cups.spec, ddclient.spec, docker-compose.spec, docker.spec, dovecot-pigeonhole.spec, dovecot.spec, enchant.spec, eventlog.spec, fail2ban.spec, filesystem.spec, flannel.spec, fuse-overlayfs.spec, fuse3.spec, gflags.spec, govmomi.spec, iana-etc.spec, iotop.spec, iproute2.spec, json_spirit.spec, lasso.spec, leveldb.spec, libaio.spec, libatomic_ops.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libmnl.spec, libnss-ato.spec, libpsl.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, mc.spec, mercurial.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nodejs.spec, nss-pam-ldapd.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, pixman.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, runc.spec, sbsigntools.spec, sshfs.spec, tiptop.spec, tzdata.spec, u-boot.spec, vulkan-tools.spec, xorg-applications.spec, zchunk.spec, zookeeper.spec |
...
| 8 | Other warnings (VMware internal URL, unmaintained repo, etc.) | 🟡 Low-Medium | 24 | autoconf213.spec, bluez-tools.spec, c-rest-engine.spec, cloud-network-setup.spec, copenapi.spec, crash.spec, cve-check-tool.spec, dhcp.spec, etcd-3.3.27.spec, heapster.spec, http-parser.spec, kubernetes-dashboard.spec, libtar.spec, motd.spec, netmgmt.spec, pcre.spec, python-argparse.spec, python-atomicwrites.spec, python-ipaddr.spec, python-lockfile.spec, python-pycodestyle.spec, python-subprocess32.spec, python-terminaltables.spec, sqlite2.spec |
