...
**218** packages with at least one issue across 8 branches.
...
| wal2json18.spec | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ |
| wayland-protocols.spec | ⚪ | 🟠7 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠6 | 🟠7 | 🟠7 | ⚪ | ⚪ |
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 37 | PyYAML.spec, apparmor.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, nerdctl.spec, netmgmt.spec, nghttp2.spec, ntp.spec, openssl.spec, passwdqc.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, python3-setuptools.spec, rdma-core.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, thin-provisioning-tools.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 43 | ca-certificates-nxtgn-openssl.spec, check.spec, eventlog.spec, filesystem.spec, gnuplot.spec, grpc.spec, iotop.spec, json_spirit.spec, lapack.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libevent.spec, libffi.spec, libpwquality.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lsof.spec, lzo.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, oniguruma.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-File-Which.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, pth.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, rapidjson.spec, s3fs-fuse.spec, tiptop.spec, wayland-protocols.spec, wireguard-tools.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 84 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, cronie.spec, dbus-python.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, font-util.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libcap.spec, libclc.spec, libdrm.spec, libfastjson.spec, libfontenc.spec, libpciaccess.spec, libslirp.spec, libtirpc.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mm-common.spec, mozjs.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perftest.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-hypothesis.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu-img.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, util-macros.spec, vulkan-tools.spec, wayland-protocols.spec, wireshark.spec, xtrans.spec |
