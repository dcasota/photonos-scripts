...
**Source file:** photonos-urlhealth-master_202605260217.prn
...
| 4 | libnetfilter_cttimeout.spec | libnetfilter_cttimeout | Warning: libnetfilter_cttimeout.spec Source0 version 1.0.1 is higher than detected latest version 1.0.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | libtirpc.spec | libtirpc | Warning: libtirpc.spec Source0 version 1.3.3 is higher than detected latest version 1-2-6 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | network-config-manager.spec | network-config-manager | Warning: network-config-manager.spec Source0 version 0.7.3 is higher than detected latest version 0.5.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | perl-Module-ScanDeps.spec | perl-Module-ScanDeps | `https://github.com/rschupp/Module-ScanDeps/archive/refs/tags/1.31.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
