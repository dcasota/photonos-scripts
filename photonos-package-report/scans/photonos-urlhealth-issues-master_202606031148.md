...
**Source file:** photonos-urlhealth-master_202606031148.prn
...
| 4 | lasso.spec | lasso | `http://dev.entrouvert.org/lasso/lasso-%{version}.tar.gz` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
| 7 | python-ruamel-yaml.spec | python-ruamel-yaml | `https://files.pythonhosted.org/packages/ruamel.yaml-0.17.21.tar.gz` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
| 8 | scons.spec | scons | `https://sourceforge.net/projects/scons/files/scons/4.5.2/scons-4.5.2.tar.gz` | Warning: Manufacturer may changed version packaging format. | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
|---|---|---|---|---|
| 1 | apache-tomcat.spec | apache-tomcat | Warning: apache-tomcat.spec Source0 version 10.1.19 is higher than detected latest version 10.0.13 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 2 | calico-libnetwork.spec | calico-libnetwork | Warning: calico-libnetwork.spec Source0 version 1.1.3 is higher than detected latest version 0.10.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | ansible-posix.spec | ansible-posix | `https://github.com/ansible-collections/ansible.posix/archive/refs/tags/1.5.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 6 | llvm.spec | llvm | `https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.7/llvm-15.0.7.src.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
