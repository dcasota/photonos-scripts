...
**261** packages with at least one issue across 8 branches.
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 36 | PyYAML.spec, apparmor.spec, bindutils.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, hiredis.spec, ibmtpm.spec, icu.spec, iperf.spec, ipxe.spec, kmod.spec, libmspack.spec, libnss-ato.spec, libwebp.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, unbound.spec, urw-fonts.spec, whois.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 85 | boost.spec, ca-certificates-nxtgn-openssl.spec, cereal.spec, checkpolicy.spec, conmon.spec, coredns.spec, cppcheck.spec, cracklib.spec, crun.spec, cython3.spec, distcc.spec, docbook-xml.spec, dosfstools.spec, dovecot-pigeonhole.spec, dovecot.spec, eventlog.spec, expat.spec, filesystem.spec, fuse3.spec, graphene.spec, gtk-doc.spec, haproxy.spec, htop.spec, iniparser.spec, iotop.spec, ipcalc.spec, jansson.spec, json-glib.spec, json_spirit.spec, jsoncpp.spec, kpatch.spec, lasso.spec, libaio.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libglvnd.spec, libgudev.spec, liblogging.spec, libmbim.spec, libssh.spec, libtraceevent.spec, libuv.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, monitoring-plugins.spec, ndctl.spec, netkit-telnet.spec, network-event-broker.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nvme-cli.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk21.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Try-Tiny.spec, perl-URI.spec, perl-YAML-Tiny.spec, pgaudit16.spec, pgbackrest.spec, pgbouncer.spec, polkit.spec, python-antlrpythonruntime.spec, python-zmq.spec, python3-hatchling.spec, python3-pyroute2.spec, rdma-core.spec, sbsigntools.spec, semodule-utils.spec, shadow.spec, shared-mime-info.spec, squashfs-tools.spec, tiptop.spec, tmux.spec, tpm2-tss.spec, tzdata.spec, xfsprogs.spec, xorg-applications.spec |
