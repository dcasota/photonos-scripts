...
**Source file:** photonos-urlhealth-master_202606052115.prn
...
| 5 | librdkafka.spec | librdkafka | Warning: librdkafka.spec Source0 version 1.8.2 is higher than detected latest version 1.6.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 10 | pam_tacplus.spec | pam_tacplus | `https://github.com/kravietz/pam_tacplus/archive/refs/tags/v1.6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | tdnf.spec | tdnf | `https://github.com/vmware/tdnf/archive/refs/tags/v3.5.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
