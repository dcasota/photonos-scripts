...
**Source file:** photonos-urlhealth-master_202605130124.prn
...
| 9 | gtk-doc.spec | gtk-doc | `https://github.com/GNOME/gtk-doc/archive/refs/tags/1.33.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 30 | python-idna.spec | python-idna | `https://github.com/kjd/idna/archive/refs/tags/v3.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 33 | yajl.spec | yajl | `https://github.com/lloyd/yajl/archive/refs/tags/2.1.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
