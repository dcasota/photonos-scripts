...
**Source file:** photonos-urlhealth-6.0_202605252236.prn
...
| 7 | nghttp2.spec | nghttp2 | Warning: nghttp2.spec Source0 version 1.57.0 is higher than detected latest version 0.7.15 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 13 | thin-provisioning-tools.spec | thin-provisioning-tools | Warning: thin-provisioning-tools.spec Source0 version 1.0.14 is higher than detected latest version 0.6.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | pth.spec | pth | `https://ftp.funet.fi/pub/gnu/ftp.gnu.org/gnu/pth/pth-2.0.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 13 | rapidjson.spec | rapidjson | `https://github.com/miloyip/rapidjson/archive/refs/tags/v1.1.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | libclc.spec | libclc | 22.1.5 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
