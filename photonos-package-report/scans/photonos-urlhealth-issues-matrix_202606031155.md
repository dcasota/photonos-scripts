...
**217** packages with at least one issue across 8 branches.
...
| ansible-posix.spec | 🟢 | 🟢 | 🟠6 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟠6 | 🟢 | ⚪ | 📌 |
| apache-tomcat.spec | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🟢 | 🟠5 | ⚪ | ⚪ | ⚪ |
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 34 | PyYAML.spec, apache-tomcat.spec, apparmor.spec, calico-libnetwork.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, influxdb.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, memcached.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 46 | ansible-posix.spec, ca-certificates-nxtgn-openssl.spec, colm.spec, ding-libs.spec, double-conversion.spec, dovecot-pigeonhole.spec, dovecot.spec, eventlog.spec, filesystem.spec, fuse3.spec, gtest.spec, iotop.spec, iputils.spec, json-glib.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libfastjson.spec, libnftnl.spec, linux-api-headers.spec, linux-esx.spec, llvm.spec, log4cpp.spec, lzo.spec, netkit-telnet.spec, network-config-manager.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, passwdqc.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, ruby.spec, tiptop.spec, tzdata.spec, wayland-protocols.spec, xinetd.spec, xorg-applications.spec |
