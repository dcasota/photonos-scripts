...
**Source file:** photonos-urlhealth-4.0_202605252222.prn
...
| 11 | ntp.spec | ntp | Warning: ntp.spec Source0 version 4.2.8p18 is higher than detected latest version 4.2.5 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | python3-setuptools.spec | python3-setuptools | Warning: python3-setuptools.spec Source0 version 65.5.1 is higher than detected latest version 40.1.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 10 | oniguruma.spec | oniguruma | `https://github.com/kkos/oniguruma/releases/download/v6.9.5/onig-6.9.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
