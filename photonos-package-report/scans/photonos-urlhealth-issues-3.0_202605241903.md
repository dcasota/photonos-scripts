...
**Source file:** photonos-urlhealth-3.0_202605241903.prn
...
| 4 | erlang-sd_notify.spec | erlang-sd_notify | `https://github.com/systemd/erlang-sd_notify/archive/refs/tags/v1.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 5 | erlang.spec | erlang | `https://github.com/erlang/otp/archive/refs/tags/OTP-25.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | libical.spec | libical | `https://github.com/libical/libical/releases/download/v3.0.7/libical-3.0.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 28 | python-wcwidth.spec | python-wcwidth | `https://github.com/jquast/wcwidth/archive/refs/tags/0.1.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 29 | tiptop.spec | tiptop | `https://files.inria.fr/pacap/tiptop/tiptop-2.3.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
