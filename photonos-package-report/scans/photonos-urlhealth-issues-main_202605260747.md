...
**Source file:** photonos-urlhealth-main_202605260747.prn
...
| 11 | perl-IO-Socket-SSL.spec | perl-IO-Socket-SSL | `https://github.com/noxxi/p5-io-socket-ssl/archive/refs/tags/2.090.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
