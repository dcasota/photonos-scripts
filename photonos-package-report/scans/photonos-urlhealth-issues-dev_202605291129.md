...
**Source file:** photonos-urlhealth-dev_202605291129.prn
...
| 10 | rpm-ostree.spec | rpm-ostree | Warning: rpm-ostree.spec Source0 version 2023.10 is higher than detected latest version 2020.10 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | c-ares.spec | c-ares | `https://github.com/c-ares/c-ares/archive/refs/tags/v1.18.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 3 | calico-confd.spec | calico-confd | `https://github.com/kelseyhightower/confd/archive/refs/tags/v0.16.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
