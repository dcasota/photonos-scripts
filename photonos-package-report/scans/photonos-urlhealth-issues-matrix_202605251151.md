...
**213** packages with at least one issue across 8 branches.
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 33 | PyYAML.spec, apparmor.spec, calico-bird.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, kafka.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vernemq.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 42 | aide.spec, ca-certificates-nxtgn-openssl.spec, cloud-utils.spec, dwarves.spec, eventlog.spec, filesystem.spec, getdns.spec, hyperscan.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libevent.spec, libfastjson.spec, libnftnl.spec, libxcb.spec, libxslt.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, mm-common.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, open-vmdk.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IO-Socket-SSL.spec, perl-IPC-Run.spec, perl-libintl.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, tiptop.spec, userspace-rcu.spec, xorg-applications.spec |
