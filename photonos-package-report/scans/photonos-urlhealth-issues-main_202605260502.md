...
**Source file:** photonos-urlhealth-main_202605260502.prn
...
| 3 | libX11.spec | libX11 | `https://gitlab.freedesktop.org/xorg/lib/libx11/-/archive/libX11-1.8.5/libx11-libX11-1.8.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | libnetconf2.spec | libnetconf2 | `https://github.com/CESNET/libnetconf2/archive/refs/tags/v3.5.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
