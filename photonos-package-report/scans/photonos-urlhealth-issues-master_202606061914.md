...
**Source file:** photonos-urlhealth-master_202606061914.prn
...
| 2 | cryptsetup.spec | cryptsetup | Warning: cryptsetup.spec Source0 version 2.4.3 is higher than detected latest version 1.6.5 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | libpsl.spec | libpsl | `https://github.com/rockdaboot/libpsl/archive/refs/tags/0.21.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
