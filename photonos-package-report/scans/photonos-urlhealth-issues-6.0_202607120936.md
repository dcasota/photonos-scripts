...
**Source file:** photonos-urlhealth-6.0_202607120936.prn

**Total packages analyzed:** 1093

**Total packages with issues:** 112
...
| 4 | linux.spec | linux | Warning: linux.spec Source0 version 6.1.158-acvp} is higher than detected latest version 6.1.177 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | ncurses.spec | ncurses | Warning: ncurses.spec Source0 version 6.5 is higher than detected latest version 4.0.970308 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 7 | openjdk11.spec | openjdk | Warning: openjdk11.spec Source0 version 11.0.29 is higher than detected latest version  . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | expat.spec | expat | `https://github.com/libexpat/libexpat/releases/download/R_2.7.3/expat-2.7.3.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | fping.spec | fping | `https://github.com/schweikert/fping/archive/refs/tags/v5.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 6 | ipxe.spec | ipxe | `https://github.com/ipxe/ipxe/archive/refs/tags/v1.21.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 7 | jsoncpp.spec | jsoncpp | `https://github.com/open-source-parsers/jsoncpp/archive/refs/tags/1.9.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | libepoxy.spec | libepoxy | `https://github.com/anholt/libepoxy/archive/refs/tags/1.5.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | libwebp.spec | libwebp | `https://github.com/webmproject/libwebp/archive/refs/tags/v1.3.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 13 | lksctp-tools.spec | lksctp-tools | `https://github.com/sctp/lksctp-tools/archive/refs/tags/v1.0.19.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 18 | protobuf-c.spec | protobuf-c | `https://github.com/protobuf-c/protobuf-c/archive/refs/tags/v1.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 20 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2024b.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
