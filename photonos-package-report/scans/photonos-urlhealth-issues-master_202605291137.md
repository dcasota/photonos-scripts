...
**Source file:** photonos-urlhealth-master_202605291137.prn
...
|---|---|---|---|---|
| 1 | bash-completion.spec | bash-completion | `https://github.com/scop/bash-completion/releases/download/2.15.0/bash-completion-2.15.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | google-benchmark.spec | google-benchmark | `https://github.com/google/benchmark/archive/refs/tags/v1.7.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | perl-File-Which.spec | perl-File-Which | `https://github.com/uperl/File-Which/archive/refs/tags/v1.27.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 16 | strongswan.spec | strongswan | `https://github.com/strongswan/strongswan/releases/download/5.9.8/strongswan-5.9.8.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 17 | xerces-c.spec | xerces-c | `https://github.com/apache/xerces-c/archive/refs/tags/v3.2.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | dtb-raspberrypi.spec | dtb-raspberrypi | 20250916 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
