...
**Source file:** photonos-urlhealth-6.0_202605111534.prn
...
| 11 | iptraf-ng.spec | iptraf-ng | `https://github.com/iptraf-ng/iptraf-ng/archive/refs/tags/v1.2.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 16 | libdrm.spec | libdrm | `https://gitlab.freedesktop.org/mesa/libdrm/-/archive/libdrm-2.4.125/libdrm-libdrm-2.4.125.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 28 | python-alabaster.spec | python-alabaster | `https://github.com/bitprophet/alabaster/archive/refs/tags/0.7.12.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 29 | python-dateutil.spec | python-dateutil | `https://github.com/dateutil/dateutil/archive/refs/tags/2.8.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 32 | termshark.spec | termshark | `https://github.com/gcla/termshark/archive/refs/tags/v2.4.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
