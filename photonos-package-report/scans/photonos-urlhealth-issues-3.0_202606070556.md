...
**Source file:** photonos-urlhealth-3.0_202606070556.prn
...
| 16 | zlib.spec | zlib | Warning: zlib.spec Source0 version 1.2.11 is higher than detected latest version 0.79 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | cyrus-sasl.spec | cyrus-sasl | `https://github.com/cyrusimap/cyrus-sasl/archive/refs/tags/cyrus-sasl-2.1.26.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
