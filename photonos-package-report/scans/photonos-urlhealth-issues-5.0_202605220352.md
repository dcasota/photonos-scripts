...
**Source file:** photonos-urlhealth-5.0_202605220352.prn
...
| 28 | python-pyrsistent.spec | python-pyrsistent | `https://github.com/tobgu/pyrsistent/archive/refs/tags/v0.18.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
