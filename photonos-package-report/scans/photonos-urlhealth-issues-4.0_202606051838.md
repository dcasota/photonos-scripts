...
**Source file:** photonos-urlhealth-4.0_202606051838.prn
...
| 12 | powershell.spec | powershell | Warning: powershell.spec Source0 version 7.4.15 is higher than detected latest version 7.4.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
