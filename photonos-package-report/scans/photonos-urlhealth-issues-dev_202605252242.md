...
**Source file:** photonos-urlhealth-dev_202605252242.prn
...
| 7 | passwdqc.spec | passwdqc | Warning: passwdqc.spec Source0 version 2.0.2 is higher than detected latest version 1.2.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 15 | wayland-protocols.spec | wayland-protocols | `https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.31/downloads/wayland-protocols` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
