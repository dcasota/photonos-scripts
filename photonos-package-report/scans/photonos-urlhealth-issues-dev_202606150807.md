...
**Source file:** photonos-urlhealth-dev_202606150807.prn
...
| 10 | snoopy.spec | snoopy | Warning: snoopy.spec Source0 version 2.5.1 is higher than detected latest version 2.2.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 11 | strongswan.spec | strongswan | Warning: strongswan.spec Source0 version 5.9.8 is higher than detected latest version 4.0.4 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | bats.spec | bats | `https://github.com/bats-core/bats-core/archive/refs/tags/v1.8.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 3 | cryptsetup.spec | cryptsetup | `https://github.com/mbroz/cryptsetup/archive/refs/tags/v2.4.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 6 | git-lfs.spec | git-lfs | `https://github.com/git-lfs/git-lfs/archive/refs/tags/v3.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | libyang.spec | libyang | `https://github.com/CESNET/libyang/archive/refs/tags/v2.1.55.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 21 | perl-Module-ScanDeps.spec | perl-Module-ScanDeps | `https://github.com/rschupp/Module-ScanDeps/archive/refs/tags/1.31.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 22 | perl-Try-Tiny.spec | perl-Try-Tiny | `https://github.com/p5sagit/Try-Tiny/archive/refs/tags/v0.31.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 23 | rpm.spec | rpm | `https://github.com/rpm-software-management/rpm/archive/refs/tags/rpm-4.19.1.1-release.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 18 | mozjs.spec | mozjs | 151.0.4 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
