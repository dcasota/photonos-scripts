...
**Source file:** photonos-urlhealth-dev_202606060002.prn
...
|---|---|---|---|---|
| 1 | distcc.spec | distcc | `https://github.com/distcc/distcc/releases/download/v3.4/distcc-3.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | pgaudit16.spec | pgaudit | `https://github.com/pgaudit/pgaudit/archive/refs/tags/16.16.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
