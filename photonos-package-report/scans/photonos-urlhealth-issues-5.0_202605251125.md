...
**Source file:** photonos-urlhealth-5.0_202605251125.prn

**Total packages analyzed:** 1629

**Total packages with issues:** 120

**Vendor-pinned subrelease (frozen for a Photon sub-release) — informational, not an issue:** 576
...
| 9 | perl-libintl.spec | perl-libintl | `https://github.com/gflohr/libintl-perl/archive/refs/tags/v1.35.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | userspace-rcu.spec | userspace-rcu | `https://github.com/urcu/userspace-rcu/archive/refs/tags/v0.13.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
