...
**Source file:** photonos-urlhealth-dev_202605241720.prn
...
| 21 | nano.spec | nano | `https://ftpmirror.gnu.org/nano/nano-8.2.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 31 | python-pyflakes.spec | python-pyflakes | `https://github.com/PyCQA/pyflakes/archive/refs/tags/2.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 32 | strongswan.spec | strongswan | `https://github.com/strongswan/strongswan/releases/download/5.9.8/strongswan-5.9.8.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 6 | crash.spec | crash | 200 |  | Warning: Source0 seems invalid and no other Official source has been found. | Source0 URL appears invalid and no official source found. Find the correct upstream URL. |
