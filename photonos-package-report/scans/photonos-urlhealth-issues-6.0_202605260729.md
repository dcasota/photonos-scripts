...
**Source file:** photonos-urlhealth-6.0_202605260729.prn
...
| 7 | open-isns.spec | open-isns | Warning: open-isns.spec Source0 version 0.101 is higher than detected latest version 0.94 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | perl-JSON.spec | perl-JSON | Warning: perl-JSON.spec Source0 version 4.10 is higher than detected latest version 3.99.01 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | spirv-headers.spec | spirv-headers | `https://github.com/KhronosGroup/SPIRV-Headers/archive/refs/tags/vulkan-sdk-1.4.313.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
