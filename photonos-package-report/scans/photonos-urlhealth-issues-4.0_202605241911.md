...
**Source file:** photonos-urlhealth-4.0_202605241911.prn
...
| 24 | pmd-ng.spec | pmd-ng | `https://github.com/vmware/pmd-next-gen/archive/refs/tags/v0.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 25 | python-automat.spec | python-automat | `https://github.com/glyph/automat/archive/refs/tags/v20.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | python-ethtool.spec | python-ethtool | `https://github.com/fedora-python/python-ethtool/archive/refs/tags/v0.15.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 29 | tiptop.spec | tiptop | `https://files.inria.fr/pacap/tiptop/tiptop-2.3.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 47 | mozjs.spec | mozjs | 151.0.1 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
| 48 | ncurses.spec | ncurses | 6.6.20260523 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
