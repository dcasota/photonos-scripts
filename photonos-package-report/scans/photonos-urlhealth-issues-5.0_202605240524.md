...
**Source file:** photonos-urlhealth-5.0_202605240524.prn
...
| 3 | duktape.spec | duktape | Warning: duktape.spec Source0 version 2.7.0 is higher than detected latest version 0.10.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | gnome-common.spec | gnome-common | `https://download.gnome.org/sources/gnome-common/3.18/gnome-common-3.18.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 62 | python-more-itertools.spec | python-more-itertools | 11.1.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
