...
**Source file:** photonos-urlhealth-5.0_202605260200.prn
...
| 12 | openjdk17.spec | openjdk | Warning: openjdk17.spec Source0 version 17.0.18 is higher than detected latest version  . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | oniguruma.spec | oniguruma | `https://github.com/kkos/oniguruma/releases/download/v6.9.8/onig-6.9.8.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | re2.spec | re2 | `https://github.com/google/re2/archive/refs/tags/20220601.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
