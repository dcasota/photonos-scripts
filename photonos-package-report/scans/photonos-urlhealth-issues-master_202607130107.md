...
**Source file:** photonos-urlhealth-master_202607130107.prn
...
| 4 | less.spec | less | Warning: less.spec Source0 version 608 is higher than detected latest version 557 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | rsync.spec | rsync | Warning: rsync.spec Source0 version 3.2.7 is higher than detected latest version 3.0.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 11 | xz.spec | xz | Warning: xz.spec Source0 version 5.4.0 is higher than detected latest version 5.2.13 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | XML-Parser.spec | XML-Parser | `https://github.com/toddr/XML-Parser/archive/refs/tags/2.46.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | check.spec | check | `https://github.com/libcheck/check/archive/refs/tags/0.15.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | expat.spec | expat | `https://github.com/libexpat/libexpat/releases/download/R_2.6.0/expat-2.6.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 6 | flannel.spec | flannel | `https://github.com/flannel-io/flannel/archive/refs/tags/v0.22.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 7 | geos.spec | geos | `https://github.com/libgeos/geos/archive/refs/tags/3.11.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 8 | gnu-efi.spec | gnu-efi | `https://download.sourceforge.net/gnu-efi/gnu-efi-3.0.15.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | keepalived.spec | keepalived | `https://github.com/acassen/keepalived/archive/refs/tags/v2.2.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 17 | linux.spec | linux | `http://www.kernel.org/pub/linux/kernel/v6.x/linux-6.1.83-acvp}.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 22 | pandoc.spec | pandoc | `https://github.com/jgm/pandoc/archive/refs/tags/2.19.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 23 | passwdqc.spec | passwdqc | `https://github.com/openwall/passwdqc/archive/refs/tags/PASSWDQC_2.0.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 28 | spirv-tools.spec | spirv-tools | `https://github.com/KhronosGroup/SPIRV-Tools/archive/refs/tags/vulkan-sdk-1.3.231.1.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 29 | tmux.spec | tmux | `https://github.com/tmux/tmux/archive/refs/tags/3.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 30 | tpm2-pytss.spec | tpm2-pytss | `https://github.com/tpm2-software/tpm2-pytss/archive/refs/tags/2.2.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 31 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2022g.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 33 | xerces-c.spec | xerces-c | `https://github.com/apache/xerces-c/archive/refs/tags/v3.2.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
