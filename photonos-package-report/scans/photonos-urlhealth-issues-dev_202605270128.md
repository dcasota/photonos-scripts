...
**Source file:** photonos-urlhealth-dev_202605270128.prn
...
| 2 | gobgp.spec | gobgp | Warning: gobgp.spec Source0 version 3.1.0 is higher than detected latest version 1.20 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | pycurl.spec | pycurl | `https://github.com/pycurl/pycurl/archive/refs/tags/REL_7.45.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
