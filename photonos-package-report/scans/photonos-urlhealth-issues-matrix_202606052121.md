...
**250** packages with at least one issue across 8 branches.
...
| gdk-pixbuf.spec | ⚪ | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| gflags.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| glog.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠6 | ⚪ | ⚪ |
| gnupg.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| go-md2man.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| govmomi.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠6 | ⚪ | ⚪ |
...
| perl-List-MoreUtils.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠6 | ⚪ | ⚪ |
...
| python-enum.spec | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| python-filelock.spec | ⚪ | 🟠7 | 🟠7 | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟢 | 🟠7 | ⚪ | 📌 |
...
| tdnf.spec | 🟢 | 🟢 | 🟢 | 📌 | 📌 | 🟢 | ⚪ | 🟢 | 🟠6 | 🟢 | 📌 | 📌 |
| thin-provisioning-tools.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| tiptop.spec | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| tmux.spec | 🟢 | 🟠5 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| tpm2-pkcs11.spec | ⚪ | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | 📌 |
| tree.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 64 | PyPAM.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, fcgi.spec, filesystem.spec, finger.spec, font-util.spec, hyper-v.spec, iptraf.spec, libICE.spec, libSM.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXcursor.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libassuan.spec, libfontenc.spec, libgsystem.spec, libpciaccess.spec, libsepol.spec, libxshmfence.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, procps-ng.spec, proto.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-passlib.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, util-macros.spec, wal2json18.spec, xorg-applications.spec, xorg-fonts.spec, xtrans.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 34 | PyYAML.spec, apparmor.spec, bcc.spec, containers-common.spec, crash.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, gtk-doc.spec, hawkey.spec, httpd.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, librdkafka.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, nodejs.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 75 | apache-tomcat-native.spec, backward-cpp.spec, ca-certificates-nxtgn-openssl.spec, cloud-init.spec, dbus-glib.spec, double-conversion.spec, dovecot-pigeonhole.spec, dovecot.spec, edgex.spec, eventlog.spec, expat.spec, filesystem.spec, fuse3.spec, gdk-pixbuf.spec, gflags.spec, glog.spec, gnupg.spec, go-md2man.spec, govmomi.spec, htop.spec, iotop.spec, iputils.spec, jemalloc.spec, json_spirit.spec, kapacitor.spec, lasso.spec, libbpf.spec, libbsd.spec, libcap.spec, libdaemon.spec, libdisplay-info.spec, libfido2.spec, libmd.spec, libseccomp.spec, libtracefs.spec, linux-api-headers.spec, linux-esx.spec, linuxptp.spec, log4cpp.spec, lz4.spec, lzo.spec, man-pages.spec, mokutil.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, oniguruma.spec, open-sans-fonts.spec, openjdk25.spec, pam_tacplus.spec, passwdqc.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-YAML.spec, pgbackrest.spec, photon-os-installer.spec, procmail.spec, python-antlrpythonruntime.spec, python-linux-procfs.spec, python3-hatchling.spec, s3fs-fuse.spec, snappy.spec, sssd.spec, subversion.spec, tdnf.spec, thin-provisioning-tools.spec, tiptop.spec, tpm2-pkcs11.spec, tree.spec, tzdata.spec, xmlsec1.spec |
