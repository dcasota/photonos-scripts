...
**Source file:** photonos-urlhealth-5.0_202606060516.prn
...
| 6 | libhugetlbfs.spec | libhugetlbfs | Warning: libhugetlbfs.spec Source0 version 2.23 is higher than detected latest version 2.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | libepoxy.spec | libepoxy | `https://github.com/anholt/libepoxy/archive/refs/tags/1.5.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 8 | log4cpp.spec | log4cpp | `https://netix.dl.sourceforge.net/project/log4cpp/log4cpp-1.1.x%20%28new%29/log4cpp-1.1/log4cpp-1.1.6` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | perl-File-Which.spec | perl-File-Which | `https://github.com/uperl/File-Which/archive/refs/tags/v1.27.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
