...
**Source file:** photonos-urlhealth-3.0_202606052327.prn
...
| 5 | jsoncpp.spec | jsoncpp | `https://github.com/open-source-parsers/jsoncpp/archive/refs/tags/1.7.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
