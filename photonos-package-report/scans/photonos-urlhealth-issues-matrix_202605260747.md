...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 38 | PyYAML.spec, apparmor.spec, bazel.spec, containers-common.spec, cppcheck.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, kubernetes.spec, libmspack.spec, libnss-ato.spec, librdkafka.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, open-isns.spec, openssl.spec, pcstat.spec, perl-JSON.spec, perl-Module-ScanDeps.spec, proto.spec, pycurl.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vim.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 41 | apache-tomcat-native.spec, ca-certificates-nxtgn-openssl.spec, dwarves.spec, eventlog.spec, filesystem.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libdrm.spec, libestr.spec, libevent.spec, libpwquality.spec, libssh2.spec, libtirpc.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, man-pages.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, oniguruma.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Crypt-SSLeay.spec, perl-Data-Dump.spec, perl-IO-Socket-SSL.spec, perl-IPC-Run.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, spirv-headers.spec, tiptop.spec, wireguard-tools.spec, xorg-applications.spec |
