...
| perl-Module-ScanDeps.spec | 🟢 | 🟢 | 🟠5 | ⚪ | ⚪ | 🟠5 | ⚪ | 🟢 | 🟠6 | 🟠5 | ⚪ | ⚪ |
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 39 | PyPAM.spec, acl.spec, cdrkit.spec, cpulimit.spec, dcerpc.spec, fcgi.spec, filesystem.spec, finger.spec, freetype2.spec, hyper-v.spec, iptraf.spec, libassuan.spec, libgsystem.spec, libsepol.spec, lightstep-tracer-cpp.spec, likewise-open.spec, linux.spec, ndsend.spec, openjdk11_aarch64.spec, openjdk17_aarch64.spec, procps-ng.spec, python-daemon.spec, python-enum.spec, python-installer.spec, python-ruamel-yaml.spec, python3-Pygments.spec, python3-iniconfig.spec, python3-iniparse.spec, python3-legacy-cgi.spec, python3-markupsafe.spec, python3-roman-numerals.spec, python3-trove-classifiers.spec, python3-wheel.spec, repmgr18.spec, scons.spec, sendmail.spec, sqlite2.spec, ulogd.spec, wal2json18.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 41 | PyYAML.spec, apparmor.spec, calico.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, hunspell.spec, ibmtpm.spec, ipxe.spec, json-glib.spec, libmspack.spec, libnetfilter_cttimeout.spec, libnss-ato.spec, libtirpc.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, memcached.spec, motd.spec, netmgmt.spec, network-config-manager.spec, nginx.spec, openjdk17.spec, openssl.spec, paramiko.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, re2.spec, rpm-ostree.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 43 | ca-certificates-nxtgn-openssl.spec, cloud-init.spec, cronie.spec, ddclient.spec, erlang-sd_notify.spec, eventlog.spec, filesystem.spec, gnuplot.spec, htop.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libevent.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, oniguruma.spec, open-sans-fonts.spec, openjdk25.spec, pam_tacplus.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Module-ScanDeps.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, re2.spec, rng-tools.spec, serf.spec, termshark.spec, tiptop.spec, tpm2-pytss.spec, xmlsec1.spec, xorg-applications.spec |
