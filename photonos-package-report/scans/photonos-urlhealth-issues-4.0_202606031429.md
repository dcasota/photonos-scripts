...
**Source file:** photonos-urlhealth-4.0_202606031429.prn
...
|---|---|---|---|---|
| 1 | apr-util.spec | apr-util | `https://github.com/apache/apr-util/archive/refs/tags/1.6.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | libnl.spec | libnl | `https://github.com/thom311/libnl/archive/refs/tags/libnl3.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 10 | libuv.spec | libuv | `https://github.com/libuv/libuv/archive/refs/tags/v1.45.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 16 | powershell.spec | powershell | `https://github.com/PowerShell/PowerShell/archive/refs/tags/v7.4.15.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 17 | tiptop.spec | tiptop | `https://files.inria.fr/pacap/tiptop/tiptop-2.3.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
