...
**Source file:** photonos-urlhealth-main_202607121246.prn

**Total packages analyzed:** 1621

**Total packages with issues:** 105
...
| 2 | cracklib.spec | cracklib | `https://github.com/cracklib/cracklib/archive/refs/tags/v2.10.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 3 | dool.spec | dool | `https://github.com/scottchiefbaker/dool/archive/refs/tags/v1.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | libfido2.spec | libfido2 | `https://github.com/Yubico/libfido2/archive/refs/tags/1.12.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | ncurses.spec | ncurses | `https://github.com/ThomasDickey/ncurses-snapshots/archive/refs/tags/v6.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
