...
**Source file:** photonos-urlhealth-master_202605241936.prn
...
| 14 | rrdtool.spec | rrdtool | Warning: rrdtool.spec Source0 version 1.8.0 is higher than detected latest version 1.2.30 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 23 | nss-altfiles.spec | nss-altfiles | `https://github.com/aperezdc/nss-altfiles/archive/refs/tags/v2.23.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 30 | python-snowballstemmer.spec | python-snowballstemmer | `https://github.com/snowballstem/snowball/archive/refs/tags/v2.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 31 | python-sphinxcontrib-htmlhelp.spec | python-sphinxcontrib-htmlhelp | `https://github.com/sphinx-doc/sphinxcontrib-htmlhelp/archive/refs/tags/2.0.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
