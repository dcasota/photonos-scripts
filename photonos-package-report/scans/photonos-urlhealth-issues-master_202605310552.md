...
**Source file:** photonos-urlhealth-master_202605310552.prn
...
|---|---|---|---|---|
| 1 | apache-tomcat-native.spec | apache-tomcat-native | Warning: apache-tomcat-native.spec Source0 version 2.0.3 is higher than detected latest version 1.1.24 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | icu.spec | icu | Warning: icu.spec Source0 version 72.1 is higher than detected latest version 61-2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | libxcrypt.spec | libxcrypt | `https://github.com/besser82/libxcrypt/releases/download/v4.4.36/libxcrypt-4.4.36.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | rubygem-aws-sigv4.spec | rubygem-aws-sigv4 | `https://rubygems.org/downloads/aws-sigv4-1.8.0.gem` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | sssd.spec | sssd | `https://github.com/SSSD/sssd/archive/refs/tags/2.9.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | fuse.spec | fuse | 3.13.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 13 | haproxy.spec | haproxy | 3.3.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
