...
**Source file:** photonos-urlhealth-dev_202605271116.prn
...
|---|---|---|---|---|
| 1 | cifs-utils.spec | cifs-utils | Warning: cifs-utils.spec Source0 version 7.0 is higher than detected latest version 6.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | fontconfig.spec | fontconfig | Warning: fontconfig.spec Source0 version 2.14.1 is higher than detected latest version 2.13.94 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 5 | httpd-mod_jk.spec | httpd-mod_jk | Warning: httpd-mod_jk.spec Source0 version 1.2.48 is higher than detected latest version 1.2.36 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | linux.spec | linux | Warning: linux.spec Source0 version 6.1.83-acvp} is higher than detected latest version 6.1.174 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | thin-provisioning-tools.spec | thin-provisioning-tools | Warning: thin-provisioning-tools.spec Source0 version 1.0.2 is higher than detected latest version 0.4.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | perl-Config-IniFiles.spec | perl-Config-IniFiles | `https://github.com/shlomif/perl-Config-IniFiles/archive/refs/tags/releases/3.000003.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | rpm.spec | rpm | `https://github.com/rpm-software-management/rpm/archive/refs/tags/rpm-4.19.1.1-release.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | libaio.spec | libaio | 0.3.113 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
