...
**Source file:** photonos-urlhealth-master_202606060530.prn
...
| 3 | iptables.spec | iptables | Warning: iptables.spec Source0 version 1.8.9 is higher than detected latest version 1.4.21 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | check.spec | check | `https://github.com/libcheck/check/archive/refs/tags/0.15.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | python-dateutil.spec | python-dateutil | `https://github.com/dateutil/dateutil/archive/refs/tags/2.8.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
