...
| commons-daemon.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
...
| wal2json18.spec | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ |
| wayland-protocols.spec | ⚪ | 🟠7 | 🟠6 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
| whois.spec | ⚪ | 🟢 | 🟠6 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 33 | PyYAML.spec, apparmor.spec, calico.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, proto.spec, re2.spec, rpm-ostree.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vim.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 55 | aide.spec, amdvlk.spec, autoconf.spec, bash-completion.spec, bridge-utils.spec, c-ares.spec, ca-certificates-nxtgn-openssl.spec, calico-confd.spec, cassandra.spec, chrony.spec, dbus.spec, docker.spec, eventlog.spec, filesystem.spec, glib-networking.spec, google-benchmark.spec, iotop.spec, json_spirit.spec, keepalived.spec, lasso.spec, libbsd.spec, libcap-ng.spec, libdaemon.spec, libdisplay-info.spec, liblogging.spec, libnftnl.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, mm-common.spec, net-snmp.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nss-altfiles.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-File-Which.spec, perl-IPC-Run.spec, psmisc.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, rpm.spec, slirp4netns.spec, strongswan.spec, tiptop.spec, wayland-protocols.spec, whois.spec, xerces-c.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 83 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cronie.spec, dbus-python.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, font-util.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libcap.spec, libclc.spec, libdrm.spec, libfastjson.spec, libfontenc.spec, libpciaccess.spec, libslirp.spec, libtirpc.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mozjs.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perftest.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, util-macros.spec, vulkan-tools.spec, wayland-protocols.spec, wireshark.spec, xtrans.spec |
