...
**Source file:** photonos-urlhealth-3.0_202605240507.prn
...
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 55 | Medium |
...
| 13 | python-importlib-metadata.spec | python-importlib-metadata | Warning: python-importlib-metadata.spec Source0 version 4.13.0 is higher than detected latest version 0.14 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 14 | python-pycodestyle.spec | python-pycodestyle | Warning: python-pycodestyle.spec Source0 version 2.5.0 is higher than detected latest version 2.0.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 15 | python-terminaltables.spec | python-terminaltables | Warning: python-terminaltables.spec Source0 version 3.1.10 is higher than detected latest version 3.1.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | krb5.spec | krb5 | `https://github.com/krb5/krb5/archive/refs/tags/krb5-1.17-final.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 53 | wireshark.spec | wireshark | 4.6.16 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
| 54 | xtrans.spec | xtrans | 1.6.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
| 55 | xxhash.spec | xxhash | 42 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
