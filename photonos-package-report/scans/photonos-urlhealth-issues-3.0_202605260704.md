...
**Source file:** photonos-urlhealth-3.0_202605260704.prn
...
| 3 | ipxe.spec | ipxe | Warning: ipxe.spec Source0 version 20180717 is higher than detected latest version 1.21.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | libpwquality.spec | libpwquality | `https://github.com/libpwquality/libpwquality/releases/download/libpwquality-1.4.2/libpwquality-1.4.2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
