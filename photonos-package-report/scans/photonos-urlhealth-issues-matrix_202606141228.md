...
**248** packages with at least one issue across 8 branches.
...
| snappy.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
| socat.spec | 🟢 | 🟠5 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| spirv-headers.spec | ⚪ | 🟠6 | 🟠7 | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | 📌 |
...
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 15 | 7zip.spec, PyPAM.spec, cdrkit.spec, dhcp.spec, fcgi.spec, filesystem.spec, finger.spec, iptraf.spec, libassuan.spec, ndsend.spec, nss.spec, openjdk11_aarch64.spec, sendmail.spec, sqlite2.spec, ulogd.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 40 | PyYAML.spec, apparmor.spec, cmocka.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, etcd.spec, fuse-overlayfs-snapshotter.spec, glibmm.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, llvm.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openjdk21.spec, openssl.spec, pcstat.spec, perl-libintl.spec, proto.spec, python3-setuptools.spec, rdma-core.spec, re2.spec, rrdtool.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vim.spec, wal2json17.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 96 | abseil-cpp.spec, backward-cpp.spec, bindutils.spec, ca-certificates-nxtgn-openssl.spec, check.spec, containerd.spec, cython3.spec, docker-buildx.spec, dovecot-pigeonhole.spec, dovecot.spec, dtc.spec, dwarves.spec, ethtool.spec, eventlog.spec, expat.spec, filesystem.spec, fuse3.spec, gcovr.spec, glib.spec, glide.spec, gobject-introspection.spec, google-benchmark.spec, google-compute-engine.spec, google-guest-oslogin.spec, graphene.spec, gtk-doc.spec, hyperscan.spec, iana-etc.spec, inih.spec, iotop.spec, iperf.spec, iptraf-ng.spec, ipxe.spec, json_spirit.spec, kapacitor.spec, kpatch.spec, libX11.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libestr.spec, libgd.spec, libndp.spec, libnetconf2.spec, libnss-ato.spec, libsolv.spec, libvirt.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lz4.spec, lzo.spec, mc.spec, mercurial.spec, mesa.spec, mpfr.spec, netkit-telnet.spec, nginx-ingress.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, ntp.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk17.spec, openjdk21.spec, openjdk25.spec, openresty.spec, pciutils.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Module-Install.spec, pgaudit.spec, pmd-ng.spec, policycoreutils.spec, pycurl.spec, python-antlrpythonruntime.spec, python-schedutils.spec, python3-hatchling.spec, re2.spec, rsyslog.spec, shadow.spec, shared-mime-info.spec, slirp4netns.spec, snappy.spec, spirv-headers.spec, sssd.spec, systemd.spec, systemtap.spec, tiptop.spec, tzdata.spec, u-boot.spec, xerces-c.spec, xinetd.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 53 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cronie.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, iputils.spec, kbd.spec, leveldb.spec, libclc.spec, libfastjson.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mm-common.spec, mozjs.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, vulkan-tools.spec, wayland-protocols.spec |
