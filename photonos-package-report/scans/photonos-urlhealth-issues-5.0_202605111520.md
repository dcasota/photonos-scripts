...
**Source file:** photonos-urlhealth-5.0_202605111520.prn

**Total packages analyzed:** 1113

**Total packages with issues:** 181
...
| 6 | linux.spec | linux | Warning: linux.spec Source0 version 6.1.164-acvp} is higher than detected latest version 6.1.172 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | nasm.spec | nasm | Warning: nasm.spec Source0 version 2.16.01 is higher than detected latest version 2.15.05 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 17 | rt-tests.spec | rt-tests | Warning: rt-tests.spec Source0 version 2.4 is higher than detected latest version 0.19 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 26 | perftest.spec | perftest | `https://github.com/linux-rdma/perftest/archive/refs/tags/4.5.0.20.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 29 | python-oauthlib.spec | python-oauthlib | `https://github.com/oauthlib/oauthlib/archive/refs/tags/v3.2.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 30 | telegraf.spec | telegraf | `https://github.com/influxdata/telegraf/archive/refs/tags/v1.36.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 18 | http-parser.spec | http-parser | 200 |  | Warning: repo isn't maintained anymore. | Upstream repo is no longer maintained. Consider finding a fork, alternative, or mark package as archived. |
