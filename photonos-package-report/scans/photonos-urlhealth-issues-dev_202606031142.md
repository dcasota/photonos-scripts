...
**Source file:** photonos-urlhealth-dev_202606031142.prn
...
| 6 | libnftnl.spec | libnftnl | `https://www.netfilter.org/projects/libnftnl/files/libnftnl-1.2.4.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
