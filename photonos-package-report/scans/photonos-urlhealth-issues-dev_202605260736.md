...
**Source file:** photonos-urlhealth-dev_202605260736.prn
...
| 5 | librdkafka.spec | librdkafka | Warning: librdkafka.spec Source0 version 1.8.2 is higher than detected latest version 1.4.4 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | libssh2.spec | libssh2 | `https://github.com/libssh2/libssh2/archive/refs/tags/libssh2-1.10.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | man-pages.spec | man-pages | `https://git.kernel.org/pub/scm/docs/man-pages/man-pages.git/snapshot/man-pages-5.13.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
