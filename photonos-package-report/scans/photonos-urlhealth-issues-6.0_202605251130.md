...
**Source file:** photonos-urlhealth-6.0_202605251130.prn
...
|---|---|---|---|---|
| 1 | cloud-utils.spec | cloud-utils | `https://github.com/canonical/cloud-utils/archive/refs/tags/0.32.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | getdns.spec | getdns | `https://github.com/getdnsapi/getdns/archive/refs/tags/v1.7.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | hyperscan.spec | hyperscan | `https://github.com/intel/hyperscan/archive/refs/tags/v5.4.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | libxslt.spec | libxslt | `https://github.com/GNOME/libxslt/archive/refs/tags/v1.1.39.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | mm-common.spec | mm-common | `https://gitlab.gnome.org/GNOME/mm-common/-/archive/1.0.5/mm-common-1.0.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
