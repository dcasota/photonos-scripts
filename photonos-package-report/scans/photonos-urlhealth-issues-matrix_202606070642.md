...
**238** packages with at least one issue across 8 branches.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Linux-PAM.spec | 🟠7 | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | 📌 | ⚪ |
| ModemManager.spec | 🟠7 | 🟠7 | ⚪ | 📌 | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠6 | ⚪ | 📌 | ⚪ |
| PyPAM.spec | 🔴3 | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| PyYAML.spec | 🟠5 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| aide.spec | 🟢 | 🟠7 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| alternatives.spec | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ |
| apache-tomcat-native.spec | 🟢 | 🟠6 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ |
...
| containers-common.spec | ⚪ | 🟠5 | 🟠5 | ⚪ | ⚪ | 🟠5 | ⚪ | 🟠5 | 🟠5 | 🟠6 | ⚪ | ⚪ |
| copenapi.spec | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| cracklib.spec | 🟢 | 🟢 | 🟢 | 📌 | ⚪ | 🟢 | ⚪ | 🟢 | 🟠6 | 🟢 | ⚪ | 📌 |
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 43 | PyYAML.spec, apparmor.spec, automake.spec, calico.spec, containers-common.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gnuplot.spec, gst-plugins-bad.spec, gtk3.spec, harfbuzz.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, meson.spec, motd.spec, netmgmt.spec, nodejs.spec, openssl.spec, pcstat.spec, perl-Module-ScanDeps.spec, pgbackrest.spec, proto.spec, re2.spec, socat.spec, spirv-llvm-translator.spec, sqlite.spec, subversion.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xfsprogs.spec, xorg-fonts.spec, zlib.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 82 | ModemManager.spec, apache-tomcat-native.spec, bats.spec, bcc.spec, bridge-utils.spec, ca-certificates-nxtgn-openssl.spec, cassandra.spec, containers-common.spec, cracklib.spec, cyrus-sasl.spec, device-mapper-multipath.spec, dovecot-pigeonhole.spec, dovecot.spec, efibootmgr.spec, erlang.spec, eventlog.spec, falco.spec, filesystem.spec, fuse.spec, fuse3.spec, glibmm.spec, gnuplot.spec, hyperscan.spec, iotop.spec, ipmitool.spec, jc.spec, json_spirit.spec, lasso.spec, leveldb.spec, libX11.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libepoxy.spec, libffi.spec, libtirpc.spec, libusb.spec, libxkbcommon.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lshw.spec, lzo.spec, man-db.spec, mercurial.spec, meson.spec, netkit-telnet.spec, network-event-broker.spec, newt.spec, ninja-build.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, open-vm-tools.spec, openjdk21.spec, openjdk25.spec, pciutils.spec, perl-Clone.spec, perl-DBI.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-JSON.spec, pgaudit16.spec, policycoreutils.spec, python-antlrpythonruntime.spec, python-linux-procfs.spec, python3-hatchling.spec, s3fs-fuse.spec, setools.spec, sssd.spec, sysstat.spec, termshark.spec, tiptop.spec, tmux.spec, tpm2-pytss.spec, tzdata.spec, vernemq.spec, wayland.spec, xmlsec1.spec, xorg-applications.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 85 | Linux-PAM.spec, ModemManager.spec, aide.spec, apparmor.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cri-tools.spec, cronie.spec, dbus-python.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, font-util.spec, fontconfig.spec, glog.spec, go-md2man.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libcap.spec, libdrm.spec, libfastjson.spec, libfontenc.spec, libpciaccess.spec, libslirp.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mm-common.spec, mozjs.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-filelock.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, util-macros.spec, vulkan-tools.spec, wayland-protocols.spec, xtrans.spec |
| 8 | Other warnings (VMware internal URL, unmaintained repo, etc.) | 🟡 Low-Medium | 33 | alternatives.spec, autoconf213.spec, bluez-tools.spec, c-rest-engine.spec, cloud-network-setup.spec, copenapi.spec, crash.spec, cve-check-tool.spec, dcerpc.spec, dhcp.spec, etcd-3.3.27.spec, heapster.spec, http-parser.spec, kubernetes-dashboard.spec, libgsystem.spec, libsepol.spec, libtar.spec, lightstep-tracer-cpp.spec, likewise-open.spec, motd.spec, pcre.spec, python-argparse.spec, python-atomicwrites.spec, python-ipaddr.spec, python-lockfile.spec, python-pycodestyle.spec, python-subprocess32.spec, python-terminaltables.spec, python3-Pygments.spec, python3-trove-classifiers.spec, python3-wheel.spec, scons.spec, sqlite2.spec |
