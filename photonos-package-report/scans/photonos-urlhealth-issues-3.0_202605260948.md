...
**Source file:** photonos-urlhealth-3.0_202605260948.prn
...
| 15 | tiptop.spec | tiptop | `https://files.inria.fr/pacap/tiptop/tiptop-2.3.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | toybox.spec | toybox | `https://github.com/landley/toybox/archive/refs/tags/0.8.6.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 17 | u-boot.spec | u-boot | `https://github.com/u-boot/u-boot/archive/refs/tags/v2019.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
