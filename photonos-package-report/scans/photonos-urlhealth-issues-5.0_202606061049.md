...
**Source file:** photonos-urlhealth-5.0_202606061049.prn
...
| 12 | nerdctl.spec | nerdctl | Warning: nerdctl.spec Source0 version 1.4.0 is higher than detected latest version 0.23.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
