...
**Source file:** photonos-urlhealth-6.0_202605271110.prn
...
| 3 | ipcalc.spec | ipcalc | Warning: ipcalc.spec Source0 version 1.0.2 is higher than detected latest version 0.4.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 10 | slirp4netns.spec | slirp4netns | `https://github.com/rootless-containers/slirp4netns/archive/refs/tags/v1.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
