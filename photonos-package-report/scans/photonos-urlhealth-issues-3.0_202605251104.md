...
**Source file:** photonos-urlhealth-3.0_202605251104.prn
...
| 15 | vernemq.spec | vernemq | Warning: vernemq.spec Source0 version 1.12.5 is higher than detected latest version 0.10.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | libxcb.spec | libxcb | `https://gitlab.freedesktop.org/xorg/lib/libxcb/-/archive/libxcb-1.15/libxcb-libxcb-1.15.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
