...
**Source file:** photonos-urlhealth-dev_202606141212.prn
...
| 9 | python3-setuptools.spec | python3-setuptools | Warning: python3-setuptools.spec Source0 version 69.0.3 is higher than detected latest version 44.1.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 11 | vim.spec | vim | Warning: vim.spec Source0 version 9.0.2142 is higher than detected latest version 9.0.1847 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 5 | glib.spec | glib | `https://github.com/GNOME/glib/archive/refs/tags/2.75.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 6 | glide.spec | glide | `https://github.com/Masterminds/glide/archive/refs/tags/v0.13.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | graphene.spec | graphene | `https://github.com/ebassi/graphene/archive/refs/tags/1.10.8.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | iperf.spec | iperf | `https://github.com/esnet/iperf/archive/refs/tags/3.17.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | libgd.spec | libgd | `https://github.com/libgd/libgd/releases/download/gd-2.3.3/libgd-2.3.3.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 20 | openjdk21.spec | openjdk | `https://github.com/openjdk/jdk21u/archive/refs/tags/jdk-21.0.6.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 24 | policycoreutils.spec | policycoreutils | `https://github.com/SELinuxProject/selinux/releases/download/3.5/policycoreutils-3.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 25 | re2.spec | re2 | `https://github.com/google/re2/archive/refs/tags/20220601.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 18 | mm-common.spec | mm-common | 1.0.7 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
| 19 | mozjs.spec | mozjs | 151.0.4 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
