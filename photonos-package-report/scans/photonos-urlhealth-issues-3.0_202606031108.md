...
**Source file:** photonos-urlhealth-3.0_202606031108.prn
...
| 3 | influxdb.spec | influxdb | Warning: influxdb.spec Source0 version 1.8.2 is higher than detected latest version 1.8.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | netmgmt.spec | netmgmt | 200 |  | Warning: Cannot detect correlating tags from the repo provided. | Tag detection failed. Check if upstream uses a different tagging convention. |
...
| 18 | python-subprocess32.spec | python-subprocess32 | 200 | 3.5.4 | Warning: repo isn't maintained anymore. | Upstream repo is no longer maintained. Consider finding a fork, alternative, or mark package as archived. |
