...
**Source file:** photonos-urlhealth-4.0_202605261000.prn

**Total packages analyzed:** 1033

**Total packages with issues:** 132
...
| 11 | psmisc.spec | psmisc | `http://prdownloads.sourceforge.net/psmisc/%{name}-%{version}.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
