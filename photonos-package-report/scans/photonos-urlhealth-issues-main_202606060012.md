...
**Source file:** photonos-urlhealth-main_202606060012.prn
...
|---|---|---|---|---|
| 1 | cracklib.spec | cracklib | `https://github.com/cracklib/cracklib/archive/refs/tags/v2.10.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | semodule-utils.spec | semodule-utils | `https://github.com/SELinuxProject/selinux/releases/download/3.10/semodule-utils-3.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
