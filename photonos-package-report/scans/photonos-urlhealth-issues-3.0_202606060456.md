...
**Source file:** photonos-urlhealth-3.0_202606060456.prn
...
| 29 | xorg-fonts.spec | xorg-fonts | `http://ftp.x.org/pub/individual/font/encodings-1.0.4.tar.bz2` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
| 3 | gtest.spec | gtest | `https://github.com/google/googletest/archive/refs/tags/release-1.8.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | mc.spec | mc | `https://github.com/MidnightCommander/mc/archive/refs/tags/4.8.25.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | oniguruma.spec | oniguruma | `https://github.com/kkos/oniguruma/releases/download/v6.9.3/onig-6.9.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | perl-YAML-Tiny.spec | perl-YAML-Tiny | `https://github.com/Perl-Toolchain-Gang/YAML-Tiny/archive/refs/tags/v1.73.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | kubernetes-dashboard.spec | kubernetes-dashboard | 200 |  | Warning: repo isn't maintained anymore. | Upstream repo is no longer maintained. Consider finding a fork, alternative, or mark package as archived. |
