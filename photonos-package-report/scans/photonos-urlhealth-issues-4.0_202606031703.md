...
**Source file:** photonos-urlhealth-4.0_202606031703.prn
...
| 12 | perl-DBD-SQLite.spec | perl-DBD-SQLite | Warning: perl-DBD-SQLite.spec Source0 version 1.66 is higher than detected latest version 1.43.06 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 14 | python3-setuptools.spec | python3-setuptools | Warning: python3-setuptools.spec Source0 version 65.5.1 is higher than detected latest version 19.7 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | cython3.spec | cython3 | `https://github.com/cython/cython/archive/refs/tags/3.0a6.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | gstreamer.spec | gstreamer | `http://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.26.11.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 8 | libsoup.spec | libsoup | `https://github.com/GNOME/libsoup/archive/refs/tags/2.72.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | openssh.spec | openssh | `https://github.com/openssh/openssh-portable/archive/refs/tags/V_8.9p1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
