...
**Source file:** photonos-urlhealth-3.0_202605061122.prn
...
| 12 | perl-File-Which.spec | perl-File-Which | Warning: perl-File-Which.spec Source0 version 1.22 is higher than detected latest version 1.09 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 16 | python-werkzeug.spec | python-werkzeug | Warning: python-werkzeug.spec Source0 version 0.14.1 is higher than detected latest version 0.11.15 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | harfbuzz.spec | harfbuzz | `https://github.com/harfbuzz/harfbuzz/releases/download/7.0.1/harfbuzz-7.0.1.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
