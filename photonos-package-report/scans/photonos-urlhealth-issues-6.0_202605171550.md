...
**Source file:** photonos-urlhealth-6.0_202605171550.prn
...
|---|---|---|---|---|
| 1 | audit.spec | audit | Warning: audit.spec Source0 version 3.0.9 is higher than detected latest version 3.0.3 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | linux.spec | linux | Warning: linux.spec Source0 version 6.1.158-acvp} is higher than detected latest version 6.1.173 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | openldap.spec | openldap | Warning: openldap.spec Source0 version 2.6.4 is higher than detected latest version 2.4.22 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | python-cassandra-driver.spec | python-cassandra-driver | Warning: python-cassandra-driver.spec Source0 version 3.25.0 is higher than detected latest version 1.0.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 19 | userspace-rcu.spec | userspace-rcu | Warning: userspace-rcu.spec Source0 version 0.13.2 is higher than detected latest version 0.10.3 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | amdvlk.spec | amdvlk | `https://github.com/GPUOpen-Drivers/AMDVLK/archive/refs/tags/v-2023.Q1.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 13 | jsoncpp.spec | jsoncpp | `https://github.com/open-source-parsers/jsoncpp/archive/refs/tags/1.9.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 22 | libtirpc.spec | libtirpc | `https://unlimited.dl.sourceforge.net/project/libtirpc/libtirpc/1.3.3/libtirpc-1.3.3.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 31 | rpcsvc-proto.spec | rpcsvc-proto | `https://github.com/thkukuk/rpcsvc-proto/archive/refs/tags/v1.4.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 40 | mozjs.spec | mozjs | 150.0.3 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
