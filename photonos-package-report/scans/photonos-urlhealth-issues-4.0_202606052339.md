...
**Source file:** photonos-urlhealth-4.0_202606052339.prn
...
| 5 | kmod.spec | kmod | Warning: kmod.spec Source0 version 27 is higher than detected latest version 23 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 18 | whois.spec | whois | Warning: whois.spec Source0 version 5.5.15 is higher than detected latest version 5.5.12 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | coredns.spec | coredns | `https://github.com/coredns/coredns/archive/refs/tags/v1.11.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | gtk-doc.spec | gtk-doc | `https://github.com/GNOME/gtk-doc/archive/refs/tags/1.33.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
