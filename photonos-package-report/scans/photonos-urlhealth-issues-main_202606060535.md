...
**Source file:** photonos-urlhealth-main_202606060535.prn
...
| 15 | xfsprogs.spec | xfsprogs | Warning: xfsprogs.spec Source0 version 6.0.0 is higher than detected latest version 5.16.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
