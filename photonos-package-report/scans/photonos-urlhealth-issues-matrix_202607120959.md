...
**234** packages with at least one issue across 8 branches.
...
|---|---|---|---|---|
| 1 | Source URL blank / macro unresolved (UrlHealth=blank) | 🔴 High | 11 | aufs-util.spec, chromium.spec, fio.spec, libaio.spec, libcap.spec, man-pages.spec, python-pbr.spec, raspberrypi-firmware.spec, systemtap.spec, trace-cmd.spec, tuna.spec |
| 2 | URL substitution unfinished | 🔴 High | 1 | log4cplus.spec |
| 3 | Source URL unreachable (UrlHealth=0) | 🔴 High | 19 | 7zip.spec, PyPAM.spec, cdrkit.spec, dhcp.spec, elfutils.spec, fcgi.spec, filesystem.spec, finger.spec, iptraf.spec, libassuan.spec, ndsend.spec, nss.spec, openjdk11_aarch64.spec, python-daemon.spec, python-stevedore.spec, sendmail.spec, sqlite2.spec, ulogd.spec, valgrind.spec |
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 39 | PyYAML.spec, ansible.spec, apparmor.spec, containers-common.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, fuse-overlayfs-snapshotter.spec, gobgp.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, libmspack.spec, libnss-ato.spec, libyaml.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, ncurses.spec, netmgmt.spec, openjdk11.spec, openjdk21.spec, openssl.spec, pcstat.spec, perl-libintl.spec, proto.spec, re2.spec, ruby.spec, socat.spec, strongswan.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, xorg-fonts.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 70 | ImageMagick.spec, abseil-cpp.spec, apache-maven.spec, calico-bird.spec, dos2unix.spec, dovecot-pigeonhole.spec, dovecot.spec, drpm.spec, duktape.spec, elfutils.spec, eventlog.spec, expat.spec, filesystem.spec, fping.spec, fuse3.spec, google-compute-engine.spec, haproxy-dataplaneapi.spec, iana-etc.spec, iotop.spec, iptraf-ng.spec, ipxe.spec, json_spirit.spec, jsoncpp.spec, kubernetes-dns.spec, libbsd.spec, libdaemon.spec, libdisplay-info.spec, libdrm.spec, libepoxy.spec, libnetfilter_conntrack.spec, libnss-ato.spec, libpsl.spec, libslirp.spec, libwebp.spec, linux-api-headers.spec, linux-esx.spec, lksctp-tools.spec, log4cpp.spec, lzo.spec, mpfr.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, open-vmdk.spec, openjdk10.spec, openjdk25.spec, perl-Clone.spec, perl-Config-IniFiles.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Object-Accessor.spec, pgbackrest.spec, pixman.spec, protobuf-c.spec, python-antlrpythonruntime.spec, python-linux-procfs.spec, python3-hatchling.spec, repmgr13.spec, shadow.spec, tiptop.spec, tzdata.spec, wireguard-tools.spec, xfsprogs.spec, xinetd.spec, xmlto.spec, xorg-applications.spec, xxhash.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 50 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cronie.spec, dtb-raspberrypi.spec, efivar.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kbd.spec, leveldb.spec, libclc.spec, libfastjson.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mozjs.spec, nss.spec, open-vm-tools.spec, openssh.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-google-auth.spec, python-vcs-versioning.spec, qemu.spec, rng-tools.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, unixODBC.spec, vulkan-tools.spec, wayland-protocols.spec |
| 8 | Other warnings (VMware internal URL, unmaintained repo, etc.) | 🟡 Low-Medium | 59 | alternatives.spec, autoconf213.spec, bluez-tools.spec, c-rest-engine.spec, cloud-network-setup.spec, copenapi.spec, crash.spec, cve-check-tool.spec, dbus-python.spec, dcerpc.spec, dhcp.spec, etcd-3.3.27.spec, fakeroot.spec, findutils.spec, font-util.spec, heapster.spec, http-parser.spec, icu.spec, kubernetes-dashboard.spec, libXScrnSaver.spec, libXau.spec, libXcomposite.spec, libXdamage.spec, libXdcmp.spec, libXdmcp.spec, libXext.spec, libXfixes.spec, libXfont2.spec, libXi.spec, libXrandr.spec, libXrender.spec, libXt.spec, libXtst.spec, libdrm.spec, libfontenc.spec, libgsystem.spec, libpciaccess.spec, libselinux.spec, libsepol.spec, libslirp.spec, libtar.spec, lightstep-tracer-cpp.spec, likewise-open.spec, motd.spec, pcre.spec, python-argparse.spec, python-atomicwrites.spec, python-ipaddr.spec, python-lockfile.spec, python-pycodestyle.spec, python-subprocess32.spec, python-terminaltables.spec, python3-Pygments.spec, python3-trove-classifiers.spec, python3-wheel.spec, scons.spec, sqlite2.spec, util-macros.spec, xtrans.spec |
