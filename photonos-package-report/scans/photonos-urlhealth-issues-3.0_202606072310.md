...
**Source file:** photonos-urlhealth-3.0_202606072310.prn
...
| 2 | c-ares.spec | c-ares | Warning: c-ares.spec Source0 version 1.19.1 is higher than detected latest version 1.17.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | iptables.spec | iptables | Warning: iptables.spec Source0 version 1.8.3 is higher than detected latest version 1.4.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | commons-daemon.spec | commons-daemon | `https://github.com/apache/commons-daemon/archive/refs/tags/commons-daemon-1.1.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 5 | google-compute-engine.spec | google-compute-engine | `https://github.com/GoogleCloudPlatform/compute-image-packages/archive/refs/tags/v20180905.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 6 | gtest.spec | gtest | `https://github.com/google/googletest/archive/refs/tags/release-1.8.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 15 | nghttp2.spec | nghttp2 | `https://github.com/nghttp2/nghttp2/releases/download/v1.57.0/nghttp2-1.57.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 20 | openssh.spec | openssh | `https://github.com/openssh/openssh-portable/archive/refs/tags/V_7.8p1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 21 | perl-Exporter-Tiny.spec | perl-Exporter-Tiny | `https://github.com/tobyink/p5-exporter-tiny/archive/refs/tags/1.002001.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 24 | telegraf.spec | telegraf | `https://github.com/influxdata/telegraf/archive/refs/tags/v1.28.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 25 | termshark.spec | termshark | `https://github.com/gcla/termshark/archive/refs/tags/v2.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 25 | pgaudit.spec | pgaudit | 18.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
