...
**Source file:** photonos-urlhealth-6.0_202605260205.prn
...
| 3 | json-glib.spec | json-glib | Warning: json-glib.spec Source0 version 1.6.6 is higher than detected latest version 0.16.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 8 | nginx.spec | nginx | Warning: nginx.spec Source0 version 1.26.3 is higher than detected latest version 0.7.69 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | erlang-sd_notify.spec | erlang-sd_notify | `https://github.com/systemd/erlang-sd_notify/archive/refs/tags/v1.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | xmlsec1.spec | xmlsec1 | `https://github.com/lsh123/xmlsec/releases/download/1.2.37/xmlsec1-1.2.37.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
