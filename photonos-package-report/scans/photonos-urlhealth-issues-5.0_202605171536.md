...
**Source file:** photonos-urlhealth-5.0_202605171536.prn
...
| 8 | lvm2.spec | lvm2 | Warning: lvm2.spec Source0 version 2.03.16 is higher than detected latest version 2.02.188 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 28 | python-setuptools_scm.spec | python-setuptools_scm | `https://github.com/pypa/setuptools_scm/archive/refs/tags/v7.0.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 29 | python-zope.event.spec | python-zope.event | `https://github.com/zopefoundation/zope.event/archive/refs/tags/4.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 65 | rng-tools.spec | rng-tools | 6 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
