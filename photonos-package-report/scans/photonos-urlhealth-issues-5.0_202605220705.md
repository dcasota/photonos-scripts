...
**Source file:** photonos-urlhealth-5.0_202605220705.prn
...
| 13 | xorg-applications.spec | xorg-applications | `http://ftp.x.org/pub/individual/app/bdftopcf-1.1.tar.bz2` |  | URL is unreachable. Check if the domain/host is still active. Find an alternative mirror or upstream source. |
...
| 12 | libXrandr.spec | libXrandr | `http://ftp.x.org/pub/individual/lib/libXrandr-1.5.2.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
