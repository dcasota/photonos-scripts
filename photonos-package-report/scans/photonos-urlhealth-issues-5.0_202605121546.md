...
**Source file:** photonos-urlhealth-5.0_202605121546.prn
...
| 4 | iana-etc.spec | iana-etc | Warning: iana-etc.spec Source0 version 20250711 is higher than detected latest version 20220819 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 3 | dbus.spec | dbus | `http://www.freedesktop.org/wiki/Software/dbus` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | nvme-cli.spec | nvme-cli | `https://github.com/linux-nvme/nvme-cli/archive/refs/tags/v2.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 31 | python-ply.spec | python-ply | `https://github.com/dabeaz/ply/archive/refs/tags/3.11.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 32 | rust.spec | rust | `https://github.com/rust-lang/rust/archive/refs/tags/1.87.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
