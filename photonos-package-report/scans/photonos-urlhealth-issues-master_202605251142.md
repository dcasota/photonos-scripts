...
**Source file:** photonos-urlhealth-master_202605251142.prn
...
|---|---|---|---|---|
| 1 | calico-bird.spec | calico-bird | Warning: calico-bird.spec Source0 version 0.3.3 is higher than detected latest version 0.3.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 11 | open-vmdk.spec | open-vmdk | `https://github.com/vmware/open-vmdk/archive/refs/tags/v0.3.8.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
