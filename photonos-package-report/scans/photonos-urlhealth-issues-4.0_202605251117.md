...
**Source file:** photonos-urlhealth-4.0_202605251117.prn
...
| 5 | kafka.spec | kafka | Warning: kafka.spec Source0 version 3.9.2 is higher than detected latest version 3.0.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | libfastjson.spec | libfastjson | `https://github.com/rsyslog/libfastjson/archive/refs/tags/v0.99.8.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
