...
**Source file:** photonos-urlhealth-master_202605191531.prn
...
|---|---|---|---|---|
| 1 | calico-confd.spec | calico-confd | Warning: calico-confd.spec Source0 version 0.16.0 is higher than detected latest version 0.12.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
