...
**Source file:** photonos-urlhealth-4.0_202606060508.prn
...
| 4 | google-compute-engine.spec | google-compute-engine | Warning: google-compute-engine.spec Source0 version 20191210 is higher than detected latest version 1.2.10 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 6 | influxdb.spec | influxdb | Warning: influxdb.spec Source0 version 1.8.2 is higher than detected latest version 1.8.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2023c.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
