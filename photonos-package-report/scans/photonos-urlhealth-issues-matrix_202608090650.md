...
**239** packages with at least one issue across 3 branches.
...
| Spec | 3.0 | 4.0 | 5.0 | 5.0/SPECS/90 | 5.0/SPECS/91 | 5.0/SPECS/92 |
|---|---|---|---|---|---|---|
| 7zip.spec | ⚪ | ⚪ | 🔴3 | ⚪ | ⚪ | ⚪ |
| Linux-PAM.spec | 🟠7 | 🟢 | 🟢 | 📌 | ⚪ | ⚪ |
| ModemManager.spec | 🟠7 | 🟠7 | ⚪ | 📌 | ⚪ | ⚪ |
| PyPAM.spec | 🔴3 | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ |
| PyYAML.spec | 🟠5 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| abseil-cpp.spec | ⚪ | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ |
| aide.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
...
| colm.spec | ⚪ | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| conmon.spec | ⚪ | 🟠6 | 🟢 | ⚪ | ⚪ | ⚪ |
| conntrack-tools.spec | 🔴1 | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ |
| containers-common.spec | ⚪ | 🟠5 | 🟠5 | 📌 | ⚪ | ⚪ |
| copenapi.spec | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ |
| crash.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| cronie.spec | 🟠7 | 🟠6 | 🟠7 | ⚪ | ⚪ | ⚪ |
| cve-check-tool.spec | 🟡8 | 🟡8 | ⚪ | 📌 | ⚪ | ⚪ |
| dbus-python.spec | 🟡8 | 🟡8 | 🟢 | 📌 | ⚪ | ⚪ |
| dcerpc.spec | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ |
| dhcp.spec | 🔴3 | 🔴3 | ⚪ | 📌 | ⚪ | ⚪ |
| ding-libs.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
...
| fakeroot.spec | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ |
| fcgi.spec | 🔴3 | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ |
| filesystem.spec | 🔴3 | 🔴3 | 🔴3 | ⚪ | ⚪ | ⚪ |
| findutils.spec | 🟡8 | 🟢 | 🟢 | 📌 | ⚪ | ⚪ |
| finger.spec | 🔴3 | 🔴3 | ⚪ | 📌 | ⚪ | ⚪ |
| flannel.spec | 🟢 | 🟢 | 🟠6 | 📌 | ⚪ | ⚪ |
| fmt.spec | ⚪ | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ |
| font-util.spec | 🟡8 | 🟡8 | 🟢 | ⚪ | ⚪ | ⚪ |
| fontconfig.spec | 🟠7 | 🟠7 | 🟠7 | 📌 | ⚪ | ⚪ |
| freetype2.spec | 🟢 | 🟠6 | 🟢 | ⚪ | ⚪ | ⚪ |
...
| google-compute-engine.spec | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ | ⚪ |
| govmomi.spec | 🟠7 | 🟠6 | 🟠6 | 📌 | ⚪ | ⚪ |
| gst-plugins-bad.spec | ⚪ | 🟠5 | ⚪ | 📌 | ⚪ | ⚪ |
| haproxy.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| hawkey.spec | 🟠5 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| heapster.spec | 🟡8 | 🟡8 | ⚪ | 📌 | ⚪ | ⚪ |
| http-parser.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| httpd-mod_jk.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| iana-etc.spec | 🟠6 | 🟢 | 🟢 | 📌 | ⚪ | ⚪ |
| ibmtpm.spec | 🟢 | 🟢 | 🟠5 | 📌 | ⚪ | ⚪ |
| icu.spec | 🟡8 | 🟡8 | 🟡8 | 📌 | ⚪ | ⚪ |
...
| kbd.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | ⚪ |
| kmod.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| kubernetes-dashboard.spec | 🟡8 | 🟡8 | 🟡8 | 📌 | ⚪ | ⚪ |
| leveldb.spec | 🟠7 | 🟠7 | 🟢 | ⚪ | ⚪ | ⚪ |
| libXScrnSaver.spec | ⚪ | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| libXau.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
...
| libdrm.spec | ⚪ | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| libfastjson.spec | 🟠7 | 🟠7 | 🟢 | ⚪ | ⚪ | ⚪ |
| libfontenc.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| libgd.spec | 🟠5 | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ |
| libgsystem.spec | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| libmbim.spec | 🟢 | 🟠5 | 🟢 | 📌 | ⚪ | ⚪ |
| libmnl.spec | 🔴1 | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ |
| libmspack.spec | 🟠6 | 🟠6 | 🟠6 | 📌 | ⚪ | ⚪ |
| libnetfilter_cttimeout.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| libnss-ato.spec | 🟠5 | 🟠6 | 🟠6 | 📌 | ⚪ | ⚪ |
| libnvme.spec | ⚪ | ⚪ | 🟠6 | 📌 | ⚪ | ⚪ |
| libpciaccess.spec | ⚪ | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| libpipeline.spec | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ | ⚪ |
| libsepol.spec | 🟡8 | 🟢 | 🟢 | 📌 | ⚪ | ⚪ |
| libslirp.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| libssh.spec | 🔴1 | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ |
...
| open-sans-fonts.spec | ⚪ | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ |
| open-vm-tools.spec | 🟠7 | 🟠7 | 🟠7 | 📌 | ⚪ | ⚪ |
| openjdk10.spec | 🟠7 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
...
| pcstat.spec | 🟠5 | 🟠5 | ⚪ | 📌 | ⚪ | ⚪ |
| perftest.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | ⚪ |
| perl-Config-IniFiles.spec | 🟢 | 🟠6 | 🟢 | 📌 | ⚪ | ⚪ |
| perl-ExtUtils-Config.spec | ⚪ | ⚪ | 🟠5 | ⚪ | ⚪ | ⚪ |
| perl-File-Which.spec | 🟢 | 🟢 | 🟠6 | 📌 | ⚪ | ⚪ |
| perl-IPC-Run.spec | ⚪ | 🟠6 | 🟠6 | 📌 | ⚪ | ⚪ |
| perl-List-MoreUtils.spec | 🟠7 | 🟠7 | 🟠7 | 📌 | ⚪ | ⚪ |
...
| python-argparse.spec | ⚪ | 🟡8 | ⚪ | 📌 | ⚪ | ⚪ |
| python-atomicwrites.spec | 🟡8 | 🟡8 | ⚪ | 📌 | ⚪ | ⚪ |
| python-dateutil.spec | 🟢 | 🟠6 | 🟢 | 📌 | ⚪ | ⚪ |
| python-google-auth.spec | ⚪ | ⚪ | 🟠7 | 📌 | ⚪ | ⚪ |
| python-ipaddr.spec | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ |
| python-lockfile.spec | 🟡8 | 🟡8 | ⚪ | 📌 | ⚪ | ⚪ |
| python-pycodestyle.spec | 🟡8 | 🟡8 | 🟡8 | 📌 | ⚪ | ⚪ |
| python-stevedore.spec | 🔴3 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| python-subprocess32.spec | 🟡8 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
| python-terminaltables.spec | 🟡8 | ⚪ | 🟡8 | 📌 | ⚪ | ⚪ |
| python-vcs-versioning.spec | ⚪ | ⚪ | 🟠7 | ⚪ | ⚪ | ⚪ |
| python3-Pygments.spec | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ |
| python3-ldap.spec | ⚪ | ⚪ | 🟠6 | ⚪ | ⚪ | ⚪ |
| python3-setuptools.spec | 🟢 | 🟠6 | 🟢 | 📌 | ⚪ | ⚪ |
| python3-trove-classifiers.spec | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ |
| python3-wheel.spec | ⚪ | ⚪ | 🟡8 | ⚪ | ⚪ | ⚪ |
| qemu.spec | ⚪ | ⚪ | 🟠7 | 📌 | ⚪ | ⚪ |
| raspberrypi-firmware.spec | ⚪ | 🔴1 | 🔴1 | ⚪ | ⚪ | ⚪ |
| re2.spec | ⚪ | 🟠5 | 🟠5 | ⚪ | ⚪ | ⚪ |
| repmgr10.spec | ⚪ | 🟠6 | ⚪ | ⚪ | ⚪ | ⚪ |
| repmgr14.spec | ⚪ | 🟢 | 🟠6 | 📌 | ⚪ | ⚪ |
| rpmdevtools.spec | ⚪ | ⚪ | 🟠6 | 📌 | 📌 | ⚪ |
...
| unixODBC.spec | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ | ⚪ |
| urw-fonts.spec | 🟠5 | 🟠5 | ⚪ | ⚪ | ⚪ | ⚪ |
| util-macros.spec | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ | ⚪ |
| valgrind.spec | 🟠6 | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ |
| virt-what.spec | 🔴3 | 🟢 | 🟢 | ⚪ | ⚪ | ⚪ |
| vulkan-tools.spec | ⚪ | 🟠7 | 🟠6 | 📌 | ⚪ | ⚪ |
| wayland-protocols.spec | ⚪ | 🟠7 | 🟠6 | 📌 | ⚪ | ⚪ |
| xinetd.spec | 🟠6 | 🟠6 | ⚪ | ⚪ | ⚪ | ⚪ |
| xmlto.spec | 🔴3 | 🟢 | ⚪ | 📌 | ⚪ | ⚪ |
| xorg-applications.spec | 🟠6 | 🟠6 | ⚪ | 📌 | ⚪ | ⚪ |
| xorg-fonts.spec | 🟠5 | 🟠5 | ⚪ | 📌 | ⚪ | ⚪ |
| xtrans.spec | 🟡8 | 🟡8 | 🟢 | 📌 | ⚪ | ⚪ |
| zchunk.spec | 🟢 | 🟠6 | 🟢 | ⚪ | ⚪ | ⚪ |
| zstd.spec | 🟢 | 🟠6 | 🟢 | ⚪ | ⚪ | ⚪ |
