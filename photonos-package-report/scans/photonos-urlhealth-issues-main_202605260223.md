...
**Source file:** photonos-urlhealth-main_202605260223.prn
...
|---|---|---|---|---|
| 1 | gnuplot.spec | gnuplot | `https://github.com/gnuplot/gnuplot/archive/refs/tags/5.4.5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | tpm2-pytss.spec | tpm2-pytss | `https://github.com/tpm2-software/tpm2-pytss/archive/refs/tags/1.2.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
