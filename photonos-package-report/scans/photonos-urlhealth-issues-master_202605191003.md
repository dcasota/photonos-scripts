...
**Source file:** photonos-urlhealth-master_202605191003.prn
...
| 16 | zchunk.spec | zchunk | Warning: zchunk.spec Source0 version 1.2.3 is higher than detected latest version 1.1.16 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 10 | iproute2.spec | iproute2 | `https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.0.0.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | kmod.spec | kmod | `https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-30.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 32 | python-pycparser.spec | python-pycparser | `https://github.com/eliben/pycparser/archive/refs/tags/release_v2.21.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 33 | rt-tests.spec | rt-tests | `https://git.kernel.org/pub/scm/utils/rt-tests/rt-tests.git/snapshot/rt-tests-2.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 38 | libtraceevent.spec | libtraceevent | 1.9.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 45 | mozjs.spec | mozjs | 151.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
