...
**253** packages with at least one issue across 8 branches.
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 44 | PyYAML.spec, apparmor.spec, c-ares.spec, containers-common.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, glibmm.spec, gst-plugins-bad.spec, harfbuzz.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, kube-bench.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, llvm.spec, lshw.spec, mdadm.spec, memcached.spec, mesa.spec, motd.spec, mysql.spec, netmgmt.spec, openresty.spec, openssl.spec, pcstat.spec, perl-DBI.spec, perl-Module-Install.spec, perl-Module-ScanDeps.spec, powershell.spec, python3-setuptools.spec, re2.spec, snappy.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, whois.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 71 | bzip2.spec, ca-certificates-nxtgn-openssl.spec, calico-bird.spec, calico-libnetwork.spec, chrony.spec, cups.spec, distcc.spec, dovecot-pigeonhole.spec, dovecot.spec, erlang.spec, eventlog.spec, filesystem.spec, fuse3.spec, gtk-doc.spec, httpd-mod_jk.spec, iana-etc.spec, iotop.spec, iptraf-ng.spec, ipvsadm.spec, json_spirit.spec, kmod.spec, kubernetes-metrics-server.spec, lasso.spec, leveldb.spec, libbsd.spec, libcap.spec, libdaemon.spec, libdisplay-info.spec, libhugetlbfs.spec, libnetconf2.spec, libnl.spec, libpwquality.spec, librdkafka.spec, libxslt.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lz4.spec, lzo.spec, netkit-telnet.spec, ninja-build.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk11.spec, openjdk25.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Module-ScanDeps.spec, perl-Object-Accessor.spec, perl-TermReadKey.spec, pixman.spec, polkit.spec, python-antlrpythonruntime.spec, python-dateutil.spec, python-schedutils.spec, python3-hatchling.spec, repmgr16.spec, rpcsvc-proto.spec, rpm.spec, rubygem-zip.spec, s3fs-fuse.spec, telegraf.spec, tiptop.spec, tmux.spec, tpm2-abrmd.spec, tzdata.spec, vulkan-tools.spec |
