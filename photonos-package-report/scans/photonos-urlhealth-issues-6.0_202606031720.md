...
**Source file:** photonos-urlhealth-6.0_202606031720.prn
...
| 7 | lvm2.spec | lvm2 | `https://github.com/lvmteam/lvm2/archive/refs/tags/v2.03.16.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | msr-tools.spec | msr-tools | `https://github.com/intel/msr-tools/archive/refs/tags/msr-tools-1.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | perl-DBD-SQLite.spec | perl-DBD-SQLite | `https://github.com/DBD-SQLite/DBD-SQLite/archive/refs/tags/1.76.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 13 | perl-Object-Accessor.spec | perl-Object-Accessor | `https://github.com/jib/object-accessor/archive/refs/tags/0.48.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 14 | policycoreutils.spec | policycoreutils | `https://github.com/SELinuxProject/selinux/releases/download/3.4/policycoreutils-3.4.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 15 | psmisc.spec | psmisc | `https://sourceforge.net/projects/%{name}/files/%{name}/%{name}-%{version}.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 57 | rng-tools.spec | rng-tools | 6 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
