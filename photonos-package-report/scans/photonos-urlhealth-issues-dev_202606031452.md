...
**Source file:** photonos-urlhealth-dev_202606031452.prn
...
|---|---|---|---|---|
| 1 | XML-Parser.spec | XML-Parser | Warning: XML-Parser.spec Source0 version 2.46 is higher than detected latest version 2.44 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | bluez.spec | bluez | `https://www.kernel.org/pub/linux/bluetooth/bluez-5.71.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 3 | dotnet-runtime.spec | dotnet-runtime | `https://github.com/dotnet/runtime/archive/refs/tags/v8.0.7.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 4 | ethtool.spec | ethtool | `https://git.kernel.org/pub/scm/network/ethtool/ethtool.git/snapshot/ethtool-6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 10 | libglvnd.spec | libglvnd | `https://github.com/NVIDIA/libglvnd/archive/refs/tags/v1.4.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 11 | libhugetlbfs.spec | libhugetlbfs | `https://github.com/libhugetlbfs/libhugetlbfs/releases/download/2.23/libhugetlbfs-2.23.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 12 | librdkafka.spec | librdkafka | `https://github.com/confluentinc/librdkafka/archive/refs/tags/v1.8.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 20 | repmgr15.spec | repmgr | `https://github.com/EnterpriseDB/repmgr/archive/refs/tags/v5.3.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 21 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2022g.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 22 | xorg-applications.spec | xorg-applications | `https://www.x.org/archive/individual/util/bdftopcf-7.7.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 54 | python-google-auth.spec | python-google-auth | 1946 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
