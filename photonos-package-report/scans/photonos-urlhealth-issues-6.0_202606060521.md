...
**Source file:** photonos-urlhealth-6.0_202606060521.prn
...
|---|---|---|---|---|
| 1 | ethtool.spec | ethtool | `https://git.kernel.org/pub/scm/network/ethtool/ethtool.git/snapshot/ethtool-6.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 11 | popt.spec | popt | `https://github.com/rpm-software-management/popt/archive/refs/tags/popt-1.16-release.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | kubernetes-dashboard.spec | kubernetes-dashboard | 200 |  | Warning: repo isn't maintained anymore. | Upstream repo is no longer maintained. Consider finding a fork, alternative, or mark package as archived. |
