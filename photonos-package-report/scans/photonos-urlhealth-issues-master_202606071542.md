...
**Source file:** photonos-urlhealth-master_202606071542.prn
...
| 6 | lighttpd.spec | lighttpd | `https://download.lighttpd.net/lighttpd/releases-1.4.x/lighttpd-1.4.76.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 7 | lldpad.spec | lldpad | `https://github.com/intel/openlldp/archive/refs/tags/v1.1.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 62 | wayland-protocols.spec | wayland-protocols | 1.49 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 8 | kbd.spec | kbd | 200 | 2.10.0 | Info: Packaging format .tar.xz has changed to .tar.bz2 | Review warning and take appropriate action. |
...
| 19 | scons.spec | scons | 404 | 4.10.1 | Warning: Manufacturer may changed version packaging format. | Manufacturer may have changed version packaging format. Verify the download URL pattern still works with current releases. |
