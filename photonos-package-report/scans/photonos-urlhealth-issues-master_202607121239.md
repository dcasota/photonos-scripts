...
**Source file:** photonos-urlhealth-master_202607121239.prn
...
| 7 | mkinitcpio.spec | mkinitcpio | Warning: mkinitcpio.spec Source0 version 34 is higher than detected latest version 29 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 11 | snoopy.spec | snoopy | Warning: snoopy.spec Source0 version 2.5.1 is higher than detected latest version 1.7.10 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | jemalloc.spec | jemalloc | `https://github.com/jemalloc/jemalloc/releases/download/5.3.0/jemalloc-5.3.0.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 9 | libcap-ng.spec | libcap-ng | `https://github.com/stevegrubb/libcap-ng/archive/refs/tags/v0.8.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 19 | runc.spec | runc | `https://github.com/opencontainers/runc/archive/refs/tags/v1.1.14.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 23 | xorg-applications.spec | xorg-applications | `https://www.x.org/archive/individual/util/bdftopcf-7.7.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 4 | ctags.spec | ctags | p5.9.20211226.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
