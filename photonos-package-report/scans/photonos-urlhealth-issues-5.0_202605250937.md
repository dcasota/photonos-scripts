...
**Source file:** photonos-urlhealth-5.0_202605250937.prn

**Total packages analyzed:** 1631

**Total packages with issues:** 120

**Vendor-pinned subrelease (frozen for a Photon sub-release) — informational, not an issue:** 575
...
| 18 | whois.spec | whois | Warning: whois.spec Source0 version 5.5.15 is higher than detected latest version 5.1.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | protobuf-c.spec | protobuf-c | `https://github.com/protobuf-c/protobuf-c/archive/refs/tags/v1.5.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
