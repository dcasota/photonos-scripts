...
**Source file:** photonos-urlhealth-dev_202605260451.prn
...
| 14 | runc.spec | runc | `https://github.com/opencontainers/runc/archive/refs/tags/v1.1.14.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
