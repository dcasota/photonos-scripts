...
**Source file:** photonos-urlhealth-4.0_202605260432.prn
...
| 8 | libical.spec | libical | `https://github.com/libical/libical/releases/download/v3.0.8/libical-3.0.8.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
