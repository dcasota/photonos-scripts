...
**Source file:** photonos-urlhealth-6.0_202606031445.prn
...
| 5 | libconfig.spec | libconfig | `https://github.com/hyperrealm/libconfig/archive/refs/tags/v1.7.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
