...
**Source file:** photonos-urlhealth-4.0_202605260151.prn
...
| 14 | rpm-ostree.spec | rpm-ostree | Warning: rpm-ostree.spec Source0 version 2021.10 is higher than detected latest version 2021.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
|---|---|---|---|---|
| 1 | cloud-init.spec | cloud-init | `https://github.com/canonical/cloud-init/archive/refs/tags/25.1.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 2 | ddclient.spec | ddclient | `https://github.com/ddclient/ddclient/releases/download/v3.9.0/ddclient-3.9.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 14 | rng-tools.spec | rng-tools | `https://github.com/nhorman/rng-tools/archive/refs/tags/v5.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
