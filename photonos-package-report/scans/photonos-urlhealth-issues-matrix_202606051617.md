...
**216** packages with at least one issue across 8 branches.
...
| cronie.spec | 🟠7 | 🟠7 | 🟠6 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
| cryptsetup.spec | 🟢 | 🟢 | 🟢 | 📌 | ⚪ | 🟠6 | ⚪ | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ |
| cve-check-tool.spec | 🟡8 | 🟡8 | ⚪ | 📌 | ⚪ | 🟠5 | ⚪ | 🟡8 | 🟡8 | 🟡8 | ⚪ | ⚪ |
...
| govmomi.spec | 🟠7 | 🟠6 | 🟠7 | ⚪ | ⚪ | 🟠7 | ⚪ | 🟠7 | 🟠7 | 🟠7 | ⚪ | ⚪ |
| gst-plugins-bad.spec | ⚪ | 🟠5 | ⚪ | 📌 | ⚪ | 🟠6 | ⚪ | 🟠5 | 🟠5 | 🟠5 | ⚪ | ⚪ |
| haproxy.spec | 🟢 | 🟢 | 🟢 | ⚪ | ⚪ | 🟢 | ⚪ | 🟠7 | 🟠7 | 🟢 | ⚪ | ⚪ |
| hawkey.spec | 🟠5 | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ | ⚪ |
...
| perl-Module-ScanDeps.spec | 🟢 | 🟢 | 🟠6 | ⚪ | ⚪ | 🟠5 | ⚪ | 🟢 | 🟢 | 🟠5 | ⚪ | ⚪ |
...
| 5 | Version comparison anomaly (UpdateAvailable contains Warning) | 🟠 Medium | 33 | PyYAML.spec, apparmor.spec, aws-sdk-cpp.spec, capstone.spec, containers-common.spec, cve-check-tool.spec, dnsmasq.spec, dracut.spec, dtb-raspberrypi.spec, gst-plugins-bad.spec, hawkey.spec, ibmtpm.spec, ipxe.spec, libmspack.spec, libnss-ato.spec, lightwave.spec, linux-esx.spec, linux.spec, lshw.spec, mdadm.spec, motd.spec, netmgmt.spec, openssl.spec, pcstat.spec, perl-Crypt-SSLeay.spec, perl-Module-ScanDeps.spec, re2.spec, socat.spec, syslinux.spec, systemd.spec, tmux.spec, urw-fonts.spec, vulkan-tools.spec |
| 6 | Source healthy (UrlHealth=200) but UpdateAvailable and UpdateURL blank | 🟠 Medium | 41 | ca-certificates-nxtgn-openssl.spec, cronie.spec, cryptsetup.spec, dovecot-pigeonhole.spec, dovecot.spec, eventlog.spec, fakeroot.spec, filesystem.spec, fuse3.spec, gcovr.spec, govmomi.spec, gst-plugins-bad.spec, iotop.spec, json_spirit.spec, lasso.spec, libbsd.spec, libdisplay-info.spec, libdrm.spec, libestr.spec, libpwquality.spec, linux-api-headers.spec, linux-esx.spec, log4cpp.spec, lzo.spec, mercurial.spec, netkit-telnet.spec, nodejs-10.24.0.spec, nodejs-8.17.0.spec, nodejs-9.11.2.spec, nxtgn-openssl.spec, open-sans-fonts.spec, openjdk25.spec, perftest.spec, perl-Clone.spec, perl-Data-Dump.spec, perl-IPC-Run.spec, perl-Module-ScanDeps.spec, python-antlrpythonruntime.spec, python3-hatchling.spec, tiptop.spec, tzdata.spec |
| 7 | Update version detected but UpdateURL/HealthUpdateURL blank (packaging format changed) | 🟠 Medium | 65 | Linux-PAM.spec, ModemManager.spec, apparmor.spec, bridge-utils.spec, clang.spec, commons-daemon.spec, cronie.spec, dbus-python.spec, dos2unix.spec, dtb-raspberrypi.spec, efivar.spec, erofs-utils.spec, expat.spec, findutils.spec, fontconfig.spec, glog.spec, govmomi.spec, haproxy.spec, icu.spec, iputils.spec, kexec-tools.spec, leveldb.spec, libcap.spec, libclc.spec, libdrm.spec, libfastjson.spec, libslirp.spec, libtirpc.spec, libunwind.spec, libxml2.spec, lldb.spec, llvm.spec, lxcfs.spec, mesa.spec, mozjs.spec, ncurses.spec, nss.spec, open-vm-tools.spec, openjdk10.spec, openssh.spec, perl-IPC-Run.spec, perl-List-MoreUtils.spec, perl-URI.spec, pgaudit.spec, pgaudit13.spec, pgaudit14.spec, pgaudit15.spec, pgaudit16.spec, pgaudit17.spec, polkit.spec, popt.spec, pth.spec, python-filelock.spec, python-google-auth.spec, python-pyvmomi.spec, python-vcs-versioning.spec, qemu.spec, rng-tools.spec, scons.spec, spirv-headers.spec, spirv-tools.spec, tcl.spec, unixODBC.spec, vulkan-tools.spec, wayland-protocols.spec |
