...
**Source file:** photonos-urlhealth-4.0_202607260707.prn

**Total packages analyzed:** 1033

**Total packages with issues:** 137
...
|---|---|---|---|---|
| 1 | calico.spec | calico | Warning: calico.spec Source0 version 3.26.4 is higher than detected latest version 3.18.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | motd.spec | motd | Warning: motd.spec Source0 version 0.1.3 is higher than detected latest version 0.1.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
| 5 | netmgmt.spec | netmgmt | Warning: netmgmt.spec Source0 version 1.2.0 is higher than detected latest version 1.0.4 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 7 | perl-WWW-Curl.spec | perl-WWW-Curl | Warning: perl-WWW-Curl.spec Source0 version 4.17 is higher than detected latest version 4.09 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 9 | python-zmq.spec | python-zmq | Warning: python-zmq.spec Source0 version 23.2.0 is higher than detected latest version 16.0.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 12 | thin-provisioning-tools.spec | thin-provisioning-tools | Warning: thin-provisioning-tools.spec Source0 version 0.9.0 is higher than detected latest version 0.4.2 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 2 | dbus-glib.spec | dbus-glib | `https://dbus.freedesktop.org/releases/dbus-glib/dbus-glib-0.110.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 3 | dtb-raspberrypi.spec | dtb-raspberrypi | `https://github.com/raspberrypi/linux/archive/rpi-linux-5.10.4.2021.01.07.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | falco.spec | falco | `https://github.com/falcosecurity/falco/archive/refs/tags/0.36.2.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 8 | glog.spec | glog | `https://github.com/google/glog/archive/refs/tags/v0.6.0tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 12 | libatomic_ops.spec | libatomic_ops | `https://github.com/ivmai/libatomic_ops/archive/refs/tags/v7.6.10.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 13 | libmspack.spec | libmspack | `https://github.com/kyz/libmspack/archive/refs/tags/v0.10.1alpha.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 14 | libnss-ato.spec | libnss-ato | `https://github.com/donapieppo/libnss-ato/archive/refs/tags/v20201005.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 15 | libwebp.spec | libwebp | `https://github.com/webmproject/libwebp/archive/refs/tags/v1.1.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 16 | linux.spec | linux | `http://www.kernel.org/pub/linux/kernel/v5.x/linux-5.10.260-acvp}.tar.xz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 19 | ndctl.spec | ndctl | `https://github.com/pmem/ndctl/archive/refs/tags/v69.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 21 | network-event-broker.spec | network-event-broker | `https://github.com/vmware/network-event-broker/archive/refs/tags/v0.3.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 23 | passwdqc.spec | passwdqc | `https://github.com/openwall/passwdqc/archive/refs/tags/PASSWDQC_1.4.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 25 | perl-Try-Tiny.spec | perl-Try-Tiny | `https://github.com/p5sagit/Try-Tiny/archive/refs/tags/v0.30.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 27 | socat.spec | socat | `http://www.dest-unreach.org/socat/download/socat-2.0.0.b9.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 29 | tzdata.spec | tzdata | `https://data.iana.org/time-zones/releases/tzdata2023c.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 30 | valgrind.spec | valgrind | `https://sourceware.org/pub/valgrind/valgrind-3.17.0.tar.bz2` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
| 31 | xinetd.spec | xinetd | `https://github.com/xinetd-org/xinetd/archive/refs/tags/xinetd-2.3.15.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 7 | fontconfig.spec | fontconfig | 2.18.2 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 20 | mm-common.spec | mm-common | 1.0.8 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 26 | perl-YAML.spec | perl-YAML | 1.320.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 36 | vulkan-tools.spec | vulkan-tools | 1.4.357 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
