...
**Source file:** photonos-urlhealth-5.0_202605241919.prn
...
| 26 | perl-IO-Socket-SSL.spec | perl-IO-Socket-SSL | `https://github.com/noxxi/p5-io-socket-ssl/archive/refs/tags/2.090.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 29 | python-pluggy.spec | python-pluggy | `https://github.com/pytest-dev/pluggy/archive/refs/tags/1.0.0.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
...
| 37 | lttng-tools.spec | lttng-tools | 2.15.0 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 66 | qemu.spec | qemu | /9.1.2 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
...
| 74 | util-linux.spec | util-linux | 2.42.1 | Warning: Manufacturer may changed version packaging format. | Upstream changed version/packaging format. Update the Source0 URL pattern in the spec to match the new release naming convention. |
