...
**Source file:** photonos-urlhealth-main_202605251002.prn
...
| 10 | meson.spec | meson | Warning: meson.spec Source0 version 1.10.2 is higher than detected latest version 0.58.1 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 4 | libevent.spec | libevent | `https://github.com/libevent/libevent/releases/download/release-2.1.12-stable/libevent-2.1.12-stable.` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
