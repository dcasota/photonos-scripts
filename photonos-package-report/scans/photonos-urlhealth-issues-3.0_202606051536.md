...
**Source file:** photonos-urlhealth-3.0_202606051536.prn
...
| 2 | capstone.spec | capstone | Warning: capstone.spec Source0 version 4.0.2 is higher than detected latest version 3.0 . | Version comparison heuristic may be confused by version format (date-based, alpha suffixes, etc.). Verify manually. |
...
| 5 | libestr.spec | libestr | `https://github.com/rsyslog/libestr/archive/refs/tags/v0.1.11.tar.gz` | Source URL works but update detection found no newer version. May be correct or the version detection pattern does not match upstream release naming. Verify manually. |
