...
# 
# This script downloads and installs Powershell Core 6.2.4 release, and saves necessary prerequisites in profile
#    /opt/microsoft/powershell/6.2.4/profile.ps1.
#
...
#
#    Two workarounds are necessary to be saved in profile /opt/microsoft/powershell/6.2.4/profile.ps1. Without those you might run into following issues:
