#!/bin/sh
# Deploy Powershell Core v6.2.4 on VMware Photon OS
#
# This script deploys Powershell Core v6.2.4 on VMware Photon OS. To start Powershell simply enter "pwsh6.2.4".
#
#
# History
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh6.2.4.
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v6.2.4
# See blog about PowerShell 7.0 https://devblogs.microsoft.com/powershell/announcing-powershell-7-0/.
#
# Powershell is installed in /opt/microsoft/powershell/6.2.4/ with a symbolic link "pwsh6.2.4" that points to /opt/microsoft/powershell/6.2.4/pwsh.
#
#    Especially when running on Photon OS 2.0, two workarounds are necessary to be saved in profile /opt/microsoft/powershell/6.2.4/profile.ps1.
#       Without those you might run into following issues:
#       find-module VMware.PowerCLI
#       Find-Package: /opt/microsoft/powershell/6.2.4/Modules/PowerShellGet/PSModule.psm1
#       Line |
...
#    
#       Each time pwsh6.2.4 is started the saved profile with the workarounds is loaded.
...
#  curl -O -J -L https://raw.githubusercontent.com/dcasota/photonos-scripts/master/Pwsh6.2.4OnPhotonOS.sh
#  sudo chmod a+x ./Pwsh6.2.4OnPhotonOS.sh
#  sudo ./Pwsh6.2.4OnPhotonOS.sh
#
...
export PS_VERSION=6.2.4
export PACKAGE_VERSION=6.2.4
...
export PS_INSTALL_VERSION=6.2.4
