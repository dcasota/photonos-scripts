...
#
# This script deploys Powershell v7.1.0-preview.5 on VMware Photon OS. To start Powershell simply enter "pwsh7.1.0.p5".
#
#
# History
...
# This script downloads and installs Powershell 7.1.0-preview.5 release.
#    Powershell is installed in /opt/microsoft/powershell/7.1.0-preview.5/ with a symbolic link "pwsh7.1.0.p5" that points to /opt/microsoft/powershell/7.1.0-preview.5/pwsh.
# 
#
...
export PS_INSTALL_VERSION=7.1.0.p5
