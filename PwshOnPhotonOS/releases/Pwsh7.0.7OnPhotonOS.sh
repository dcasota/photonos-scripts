#!/bin/sh
# Deploy Powershell v7.0.7 on VMware Photon OS
#
# This script deploys Powershell v7.0.7 on VMware Photon OS. To start Powershell simply enter "pwsh7.0.7".
#
#
# History
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh7.0.7.
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v7.0.7
# See blog about PowerShell 7.0 https://devblogs.microsoft.com/powershell/announcing-powershell-7-0/.
#
# Powershell is installed in /opt/microsoft/powershell/7.0.7/ with a symbolic link "pwsh7.0.7" that points to /opt/microsoft/powershell/7.0.7/pwsh.
#
#    Especially when running on Photon OS 2.0, two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.0.7/profile.ps1.
#       Without those you might run into following issues:
#       find-module VMware.PowerCLI
#       Find-Package: /opt/microsoft/powershell/7.0.7/Modules/PowerShellGet/PSModule.psm1
#       Line |
...
#    
#       Each time pwsh7.0.7 is started the saved profile with the workarounds is loaded.
...
#  curl -O -J -L https://raw.githubusercontent.com/dcasota/photonos-scripts/master/Pwsh7.0.7OnPhotonOS.sh
#  sudo chmod a+x ./Pwsh7.0.7OnPhotonOS.sh
#  sudo ./Pwsh7.0.7OnPhotonOS.sh
#
...
export PS_VERSION=7.0.7
export PACKAGE_VERSION=7.0.7
...
export PS_INSTALL_VERSION=7.0.7
