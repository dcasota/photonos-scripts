#!/bin/sh
# Deploy Powershell v7.2.0-preview.2 on VMware Photon OS
#
# This script deploys Powershell v7.2.0-preview.2 on VMware Photon OS. To start Powershell simply enter "pwsh7.2.0-preview.2".
#
#
# History
# 0.1  12.01.2021   dcasota  Initial release
# 0.2  16.02.2021   dcasota  comment fix
# 0.3  17.02.2021   dcasota  start command changed to pwsh7.2.0-preview.2
#
# Prerequisites:
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh7.2.0-preview.2.
#
...
#    
#       Each time pwsh7.2.0-preview.2 is started the saved profile with the workarounds is loaded.
...
#  curl -O -J -L https://raw.githubusercontent.com/dcasota/photonos-scripts/master/Pwsh7.2.0-preview.2OnPhotonOS.sh
#  sudo chmod a+x ./Pwsh7.2.0-preview.2OnPhotonOS.sh
...
export PS_VERSION=7.2.0-preview.2
export PACKAGE_VERSION=7.2.0-preview.2
...
export PS_INSTALL_VERSION=7.2.0-preview.2
