#!/bin/sh
# Deploy Powershell v7.1.1 on VMware Photon OS
#
# This script deploys Powershell v7.1.1 on VMware Photon OS. To start Powershell simply enter "pwsh7.1.1".
#
#
# History
...
# 
# As alternative, this script downloads and does a scripted install of Powershell Core pwsh7.1.1.
#
# See release info https://github.com/PowerShell/PowerShell/releases/tag/v7.1.1
# See blog about PowerShell 7.0 https://devblogs.microsoft.com/powershell/announcing-powershell-7-0/.
#
# Powershell is installed in /opt/microsoft/powershell/7.1.1/ with a symbolic link "pwsh7.1.1" that points to /opt/microsoft/powershell/7.1.1/pwsh.
#
#    Especially when running on Photon OS 2.0, two workarounds are necessary to be saved in profile /opt/microsoft/powershell/7.1.1/profile.ps1.
#       Without those you might run into following issues:
#       find-module VMware.PowerCLI
#       Find-Package: /opt/microsoft/powershell/7.1.1/Modules/PowerShellGet/PSModule.psm1
#       Line |
...
#    
#       Each time pwsh7.1.1 is started the saved profile with the workarounds is loaded.
...
export PS_INSTALL_VERSION=7.1.1
