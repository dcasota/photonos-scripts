#!/bin/sh
# Deploy Powershell v7.0.0 on VMware Photon OS
#
# This script deploys Powershell v7.0.0 on VMware Photon OS. To start Powershell simply enter "pwsh7".
#
#
# History
...
export PS_VERSION=7.0.0
export PACKAGE_VERSION=7.0.0
