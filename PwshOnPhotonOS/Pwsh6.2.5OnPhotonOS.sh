#!/bin/sh
# Deploy Powershell Core v6.2.5 on VMware Photon OS
#
# This script deploys Powershell Core v6.2.5 on VMware Photon OS. To start Powershell simply enter "pwsh6.2.5".
#
#
# History
...
#    
#       Each time pwsh6.2.5 is started the saved profile with the workarounds is loaded.
...
export PS_VERSION=6.2.5
export PACKAGE_VERSION=6.2.5
...
export PS_INSTALL_VERSION=6.2.5
