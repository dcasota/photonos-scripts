...
$sourcepath="C:\Users\myname\Downloads"
# output file
$outputfile="C:\Users\myname\Downloads\photonos-package-report.prn"
...
# write output
"Spec"+","+"photon-1.0"+","+"photon-2.0"+","+"photon-3.0"+","+"photon-4.0"+","+"photon-Master" |  out-file $outputfile
$result | % { $_.Spec+","+$_."photon-1.0"+","+$_."photon-2.0"+","+$_."photon-3.0"+","+$_."photon-4.0"+","+$_."photon-Master"} |  out-file $outputfile -append
